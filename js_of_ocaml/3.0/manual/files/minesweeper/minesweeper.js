...
aJ=254,C=255,aB="x",aD='"',I=1073741823,aF=250,aA="sprites/normal.png",aC="jsError",aI="sprites/flag.png",T="input",aE=785140586,D="int_of_string",X="sprites/bomb.png",az=982028505,ay=0.001,h="",W=" : file already exists",U="/",aH="fd ",aG="index out of bounds";function
...
aS(){aQ(e[4],new
f(aG))}f.prototype={string:null,bytes:null,fullBytes:null,array:null,len:null,last:0,toJsString:function(){var
...
if(this.bytes!=null)this.bytes=this.fullBytes=this.string=null;c[a]=b&C;return 0},safeSet:function(a,b){if(this.len==null)this.toBytes();if(a<0||a>=this.len)aS();this.set(a,b)},fill:function(a,b,c){if(a>=this.last&&this.last&&c==0)return;var
...
aM(){G(aG)}function
bt(a,b){if(b<0||b>=a.length-1)aM();return a[b+1]}function
bu(a,b,c){if(b<0||b>=a.length-1)aM();a[b+1]=c;return 0}function
bv(a,b,c,d,e){if(e===0)return;if(a.array!=null&&c.last==0&&d==0&&e==c.len){c.array=a.array.slice(b,b+e);c.bytes=c.string=null;return}if(d===c.last&&c.bytes!=null){var
...
instanceof
Array&&a[0]===(a[0]|0)){var
g=a[0];if(g===aJ)g=0;if(g===aF){a=a[1];continue}else
if(b
instanceof
Array&&b[0]===(b[0]|0)){var
h=b[0];if(h===aJ)h=0;if(h===aF){b=b[1];continue}else
...
aK(a){this.bytes=h;this.len=a}aK.prototype=new
f();function
bx(a){if(a<0)G("String.create");return new
aK(a)}function
bU(a){throw[0,a]}function
aR(){bU(e[6])}function
bz(a,b){if(b==0)aR();return a/b|0}function
...
bF(a){var
g=bT(a),f=g[0],h=g[1],d=g[2],i=-1>>>0,e=a.get(f),c=aO(e);if(c<0||c>=d)F(D);var
b=c;for(;;){f++;e=a.get(f);if(e==95)continue;c=aO(e);if(c<0||c>=d)break;b=d*b+c;if(b>i)F(D)}if(f!=a.getLen())F(D);b=h*b;if(d==10&&(b|0)!=b)F(D);return b|0}var
...
aL(a){var
b=a.length;this.array=a;this.len=this.last=b}aL.prototype=new
f();var
...
aP(a)}y(0,[]);y(1,[]);y(2,[]);function
bM(a){var
b=e.fds[a];if(b.flags.wronly)l(aH+a+" is writeonly");return{data:b,fd:a,opened:true}}function
...
d=e.fds[a];if(d.flags.rdonly)l(aH+a+" is readonly");var
...
bP(a,b){if(b==0)aR();return a%b}if(!Math.imul)Math.imul=function(a,b){return((a>>16)*b<<16)+(a&65535)*b|0};var
bQ=Math.imul;function
bS(a){return new
f(a)}function
bV(a,b){e[a+1]=b}var
aN={};function
bW(a,b){aN[a.toString()]=b;return 0}function
bY(){return 32}var
bC=new
Date()*ay;function
b1(){return new
Date()*ay-bC}function
bR(a){return aN[a]}function
b2(a){if(a
instanceof
...
instanceof
c.Error)return[0,bR(aC),a];return[0,e[3],new
t(String(a))]}var
d=bt,o=bu,au=bv,ax=bG,H=bJ,av=bN,_=bP,Z=bQ,b=bS,a=bV,aw=bW,bs=b2;function
u(a,b){return a.length==1?a(b):x(a,[b])}var
N=[0,b("Invalid_argument")],af=[0,b("Assert_failure")],an=b(T),ap=[0,10,10,15];a(11,[0,b("Undefined_recursive_module")]);a(10,af);a(9,[0,b("Sys_blocked_io")]);a(8,[0,b("Stack_overflow")]);a(7,[0,b("Match_failure")]);a(6,[0,b("Not_found")]);a(5,[0,b("Division_by_zero")]);a(4,[0,b("End_of_file")]);a(3,N);a(2,[0,b("Failure")]);a(1,[0,b("Sys_error")]);a(0,[0,b("Out_of_memory")]);var
aT=b("Pervasives.do_at_exit"),aW=b("Random.int"),aV=b(aB),aX=[0,987910699,495797812,364182224,414272206,318284740,990407751,383018966,270373319,840823159,24560019,536292337,512266505,189156120,730249596,143776328,51606627,140166561,366354223,1003410265,700563762,981890670,913149062,526082594,1021425055,784300257,667753350,630144451,949649812,48546892,415514493,258888527,511570777,89983870,283659902,308386020,242688715,482270760,865188196,1027664170,207196989,193777847,619708188,671350186,149669678,257044018,87658204,558145612,183450813,28133145,901332182,710253903,510646120,652377910,409934019,801085050],a0=b("Js.Error"),a1=b(aC),a5=b("img"),a4=b("br"),a3=b("div"),bj=b("YOU LOSE"),bg=b(X),bf=b(aI),bd=b("Mode : "),be=b(X),bi=b(aA),bh=b("0"),bc=b("YOU WIN"),bb=b("GAME OVER"),a7=b(aI),a8=b(X),a9=b("sprites/empty.png"),a_=b(".png"),a$=b("sprites/"),ba=b(aA),a6=[0,0,0],bm=[0,b("main.ml"),42,17],bn=b("main"),bo=b("Number of columns"),bp=b("Number of rows"),bq=b("Number of mines"),br=b("nouvelle partie"),bl=b("submit"),bk=b("text");function
z(a,b){return bB(a,b)?a:b}function
O(a,b){var
c=a.getLen(),e=b.getLen(),d=bx(c+e|0);au(a,0,d,0,c);au(b,0,d,c,e);return d}function
A(a){return b(h+a)}function
P(a,b){if(a){var
c=a[1];return[0,c,P(a[2],b)]}return b}bM(0);av(1);av(2);function
ad(a){var
b=bO(0);for(;;){if(b){var
c=b[2],d=b[1];try{bL(d)}catch(f){}var
b=c;continue}return 0}}aw(aT,ad);function
ae(a,b,c){var
...
ah=[0,0],aU=bY(0);function
ai(a){ah[1]=[0,a,ah[1]];return 0}32===aU;var
i=[0,aX.slice(),0],m=c,q=false,aj=m.Array,ak=[0,a0];aw(a1,[0,ak,{}][0+1]);var
aY=null,aZ=undefined;ai(function(a){return a[1]===ak?[0,new
...
al=[0,aE];function
am(a,b,c){for(;;){if(0===a)if(0===b)return Q(c,an);var
f=al[1];if(aE===f){try{var
i=a2.createElement('<input name="x">'),j=i.tagName.toLowerCase()===T?1:0,l=j?i.name===aB?1:0:j,g=l}catch(f){var
g=0}var
k=g?az:-1003883683;al[1]=k;continue}if(az<=f){var
d=new
aj();d.push("<",T);B(a,function(a){d.push(' type="',ax(a),aD);return 0});B(b,function(a){d.push(' name="',ax(a),aD);return 0});d.push(">");return c.createElement(d.join(h))}var
e=Q(c,an);B(a,function(a){return e.type=a});B(b,function(a){return e.name=a});return e}}function
v(a){return V(a,a4)}function
ao(a){return V(a,a5)}m.HTMLElement===aZ;function
...
c=am([0,n(bk)],0,k);c.value=n(A(b[1]));c.onchange=r(function(a){try{b[1]=bF(new
t(c.value))}catch(f){f=bs(f);if(f[1]!==N)throw f}c.value=n(A(b[1]));return q});g(d,c);return d}m.onload=r(function(a){var
l=k.getElementById(n(bn));if(l==aY)throw[0,af,bm];var
ay=[0,15],az=[0,12],aA=[0,10];g(l,S(bo,aA));g(l,v(k));g(l,S(bp,az));g(l,v(k));g(l,S(bq,ay));g(l,v(k));function
e(a){var
W=V(k,a3);g(l,W);var
aZ=ay[1],a0=aA[1],am=z(ap[1],az[1]),X=z(ap[2],a0),an=z(1,aZ),au=Z(am,X),aN=bI(au,an)?au:an,h=[0,am,X,aN],aj=[0,(b1(0)*1e3|0)%1e5|0],ac=0===aj.length-1?[0,0]:aj,ad=ac.length-1,aF=0;if(!0){var
u=aF;for(;;){o(i[1],u,u);var
aJ=u+1|0;if(54!==u){var
u=aJ;continue}break}}var
S=[0,aV],af=54+z(55,ad)|0,aG=0;if(!(af<0)){var
t=aG;for(;;){var
...
aK=w[1],aM=al(0),n=ae(h[1],h[2],aM);aq(h,function(a){var
b=a[2],c=a[1],e=al(0);return o(d(n,c),b,e)});R(function(a){d(d(n,bz(a,h[2])),_(a,h[2]))[1]=1;return 0},aK);aq(h,function(a){var
b=a[2],c=a[1];if(d(d(n,c),b)[1])return 0;var
e=[0,0];function
f(a){return d(d(n,a[1]),a[2])[1]?(e[1]++,0):0}R(f,ar(h,[0,c,b]));d(d(n,c),b)[4]=e[1];return 0});var
e=[0,n,aR,h,aQ,aP,aO],F=[0,0],p=s.createDocumentFragment();g(p,s.createTextNode(j(bd)));var
x=ao(s);g(p,x);x.src=j(be);x.onclick=r(function(a){if(0===F[1]){F[1]=1;x.src=j(bf)}else{F[1]=0;x.src=j(bg)}return q});g(p,v(s));var
av=e[3][2]-1|0,aS=0;if(!(av<0)){var
f=aS;for(;;){var
Y=[0,0],aw=e[3][1]-1|0,aU=0;if(!(aw<0)){var
b=aU;for(;;){var
c=ao(s);Y[1]=[0,c,Y[1]];c.src=j(bi);c.onclick=r(function(f,b,c){return function(a){if(0===F[1]){if(!d(d(e[1],b),f)[2])if(e[6]){if(d(d(e[1],b),f)[3]){e[4]=e[4]-1|0;d(d(e[1],b),f)[3]=0}else{e[4]=e[4]+1|0;d(d(e[1],b),f)[3]=1}E(d(d(e[2],f),b),d(d(e[1],b),f))}else
if(!d(d(e[1],b),f)[3])if(d(d(e[1],b),f)[1]){as(e);at(e);m.alert(j(bj))}else{var
l=function(a){var
...
e=k(ar(i,b)),f=e[1];return P([0,b,f],h(P(e[2],c)))}return[0,b,h(c)]}return 0};o(d(g,b),f,1);R(l,h([0,[0,b,f],0]));if(0===e[5]){as(e);at(e);m.alert(j(bc))}}}else{d(d(e[1],b),f)[3]=1-d(d(e[1],b),f)[3];E(c,d(d(e[1],b),f))}return q}}(f,b,c));g(p,c);var
...
c=k.createDocumentFragment(),b=am([0,n(bl)],0,k);b.value=n(br);b.onclick=r(e);g(c,b);g(l,c);return q});ad(0);return}(function(){return this}()));
