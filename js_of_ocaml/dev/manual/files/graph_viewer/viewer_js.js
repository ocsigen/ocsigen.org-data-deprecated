...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _cA_=caml_new_string("XmlHttpRequest.Wrong_headers"),
     _cD_=[0,0,0],
     _cG_=[0,caml_new_string("viewer_common.ml"),260,8],
     _cH_=[0,caml_new_string("viewer_common.ml"),263,8],
     _cE_=[0,caml_new_string("viewer_common.ml"),269,6],
     _cF_=[0,caml_new_string("viewer_common.ml"),272,6],
     _cB_=[0,caml_new_string("viewer_common.ml"),122,63],
     ...
     _cI_=[0,caml_new_string("viewer_js.ml"),90,26];
    ...
    new regExp_withFlags(caml_bytes_of_string(_cv_));
    if(test$0(window.location))
     var _cw_=window.location;
    else
     var
      t29="",
    ...
    urldecode_js_string_string(_cw_.hostname);
    urldecode_js_string_string(_cw_.protocol);
    var _cx_=0;
    (function(param)
       {try
         {var _ew_=[0,caml_int_of_string(caml_js_to_byte_string(_cw_.port))];
          return _ew_}
        catch(_ex_)
      ...
      (_cx_));
    var
     s$2=urldecode_js_string_string(_cw_.pathname),
    ...
    if(a$0)
     ...
     var switch$0=0;
    var
     _cy_=_cw_.search.charAt(0) === "?"?_cw_.search.slice(1):_cw_.search,
     arr=_cy_.split(make$0(1,38).toString()),
     len$0=arr.length;
     ...
     {var idx$0=idx;
      for(;;)
       {if(0 <= idx$0)
        ...
        return acc}}
    aux$0(0,len$0 - 1 | 0);
    urldecode_js_string_string(_cw_.href);
       ...
       {try
         ...
         {try
           ...
           {try
            ...
            catch(_el_){throw [0,Assert_failure,_cz_]}}}}}
        ...
        handler
         (function(param)
           {var page=doc.documentElement;
            ...
            var started=[0,0],p=unsafeCreateElement(doc,_ck_);
