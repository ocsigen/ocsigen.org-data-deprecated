...
di=123,n=254,fs=108,ft=".jpg",fr=-0.1,fD=",",at='"',_=16777215,c2="=",ar="function",fS=0.5,c_=65599,fc="jsError",ce="POST",bp=115,fq="&",fb="center",dh=120,fR="block",fa=",\n",c1="\n",c9="]",dg=117,fp="overlay",cd=126925477,fo="0000",f="0",c8=248,b7=4204112,fQ="fd ",bn="2px",aj="src/core/lwt.ml",fP="table-cell",e$="meeting-point-38.png",df="x",cc="36px",aH="en",bg="g",b0=1073741823,fC=": ",aG=105,bk="object",fB="%d",e_=443,bj=110,fO=-88,b2="text",b6="'",bZ="int_of_string",fN="table",fA=982028505,fn="move",e9="http://",bo="e",fM="1",ca=891486873,cb="button",ah="-",b5=-48,fm="globe-38.png",c7=" : file already exists",de="text on",e8="off",dd="38px",dn=101,e7=0.1,fL="index out of bounds",fl="hyp_lang",c0=125,x=255,fk="wikipedia-38.png",fK="}",fj='Content-Disposition: form-data; name="',Z=250,fJ=1.41421356237309515,cZ=2147483,cY="on",K="auto",e6=-550809787,ai=246,c6=102,e5="0px",e4="--",fi="draw",c5=870530776,d="",dc="transform",b4=781515420,aS=100,fz="info-38.png",b$="48px",dm=103,fy=936573133,y="absolute",dl="_blank",fh=1e3,fx=0.25,aU=".",bi="+",b_=65535,fg="In English",fw="ocsigen-powered.png",db="f",dk=3654627,ff="80%",fv=124,fI=785140586,b3="?",fe=-32,c4=111,bm="string",S=" ",c3="px",bl="pointer",fu="\\u",fH="lastIndex",da="hidden",cX="middle",aT=":",fd="nan",cW=116,b1="\r\n",c$="lineWidth",P="100%",fG=65520,fF="%.12g",as="/",b9=114,bh="#",e3=0.95,dj="nowrap",fE="commons-38.png",b8="null",u="number",aI;if(!aI)aI={};(function(){"use strict";function
b(a){return a<10?f+a:a}if(typeof
Date.prototype.toJSON!==ar){Date.prototype.toJSON=function(a){return isFinite(this.valueOf())?this.getUTCFullYear()+ah+b(this.getUTCMonth()+1)+ah+b(this.getUTCDate())+"T"+b(this.getUTCHours())+aT+b(this.getUTCMinutes())+aT+b(this.getUTCSeconds())+"Z":null};String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(a){return this.valueOf()}}var
c=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,g=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,e,l,h={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},i;function
n(a){g.lastIndex=0;return g.test(a)?at+a.replace(g,function(a){var
b=h[a];return typeof
b===bm?b:fu+(fo+a.charCodeAt(0).toString(16)).slice(-4)})+at:at+a+at}function
m(a,b){var
...
aI.stringify!==ar)aI.stringify=function(a,b,c){var
f;e=d;l=d;if(typeof
...
aI.parse!==ar)aI.parse=function(a,f){var
b;function
g(a,b){var
...
a=this.getFullBytes();try{return this.string=decodeURIComponent(escape(a))}catch(f){dt('MlString.toJsString: wrong encoding for "%s" ',a);return a}},toBytes:function(){if(this.string!=null)try{var
a=unescape(encodeURIComponent(this.string))}catch(f){dt('MlString.toBytes: wrong encoding for "%s" ',this.string);var
...
b={justify:bi,signstyle:ah,filler:S,alternate:false,base:0,signedconv:false,width:0,uppercase:false,sign:1,prec:-1,conv:db};for(var
d=0;d<e;d++){var
...
e=g;e<a.width;e++)c+=S;if(a.signedconv)if(a.sign<0)c+=ah;else
if(a.signstyle!=ah)c+=a.signstyle;if(a.alternate&&a.base==8)c+=f;if(a.alternate&&a.base==16)c+="0x";if(a.justify==bi&&a.filler==f)for(var
...
kD(a){return[x,a&_,a>>24&_,a>>31&b_]}function
kE(a,b){var
c=a[1]-b[1],d=a[2]-b[2]+(c>>24),e=a[3]-b[3]+(d>>24);return[x,c&_,d&_,e&b_]}function
...
fZ(a){a[3]=a[3]<<1|a[2]>>23;a[2]=(a[2]<<1|a[1]>>23)&_;a[1]=a[1]<<1&_}function
kB(a){a[1]=(a[1]>>>1|a[2]<<23)&_;a[2]=(a[2]>>>1|a[3]<<23)&_;a[3]=a[3]>>>1}function
kH(a,b){var
...
kC(a){var
b=-a[1],c=-a[2]+(b>>24),d=-a[3]+(c>>24);return[x,b&_,c&_,d&b_]}function
ky(a,b){var
...
c=0;c<d.length;c++){if(b.auto)e=b.auto;if(!(b.exists&&b.exists(d[c])))return e?e(d.join(as)):0;b=b.get(d[c])}return 1}function
...
v(String(a))]}var
i=kh,k=ki,aE=fV,bX=kl,ae=fW,cS=kq,bU=kr,cR=fX,eZ=kJ,cT=kK,E=kM,e2=kO,aq=kR,bf=kS,r=kU,eV=f1,eU=kX,eX=kZ,e1=k0,eY=bs,c=f4,ap=k5,a=k8,eW=k9,Y=la,e0=le,bY=lh,ag=li,s=lk;function
...
aZ(a,b){var
c=ae(a);kp(c,0,a,b);return c}function
al(a,b,c){if(0<=b)if(0<=c)if(!((a.getLen()-c|0)<b)){var
d=ae(c);aE(a,b,d,0,c);return d}return aK(gm)}function
...
e=ae(f[1]+eY(d.getLen(),g[1]-1|0)|0);aE(a,0,e,0,a.getLen());var
...
dF(a){return al(a,0,a.getLen())}function
dG(a,b,c){var
...
l=function(a,b){return i(aF,dM(a,b))},am=function(g,f,c,d){var
a=d;for(;;){var
...
d=[0,l(a,f),c];return am(g,H(a,f),d,b)},a+1|0);default:var
...
ab=0;else
var
ah=[0,eZ(al(D,q,(D.getLen()-q|0)-1|0)),R],ab=1;else{if(45===S){var
...
ad=ae(1);ad.safeSet(0,p);var
r=ad}else{var
C=ae(4);C.safeSet(0,92);C.safeSet(1,48+(p/aS|0)|0);C.safeSet(2,48+((p/10|0)%10|0)|0);C.safeSet(3,48+(p%10|0)|0);var
r=C}}var
...
j(aC,y);return A(a8,a7)}return a4(k,a,n)}},f=m+1|0,g=0;return dL(k,function(a,b){return am(a,p,g,b)},f)}z(c,y,d);var
...
ct=[0,0];function
cv(a,b){var
c=a[b+1];if(k3(c)){if(ap(c)===252)return j(U(gU),c);if(ap(c)===253){var
...
g=ap(bD),c=Z===g?bD[1]:ai===g?a2(bD):bD;c[2]=(c[2]+1|0)%55|0;var
...
f===u)return a<50?af(1+a,b,e):ag(af,[0,b,e]);else
switch(f[0]){case
...
af(a,b,c){return c?a<50?cU(1+a,b,c[1],c[2]):ag(cU,[0,b,c[1],c[2]]):0}function
hk(b,c,d){return bY(cU(0,b,c,d))}function
lm(b,c){return bY(af(0,b,c))}function
cV(a,b,c){var
e=b,d=c;for(;;)if(typeof
e===u)return a<50?aF(1+a,d):ag(aF,[0,d]);else
switch(e[0]){case
1:var
f=e[1];if(f[4]){f[4]=0;f[1][2]=f[2];f[2][1]=f[1]}return a<50?aF(1+a,d):ag(aF,[0,d]);case
2:var
h=[0,e[2],d],e=e[1],d=h;continue;default:var
g=e[2];$[1]=e[1];d1(g,0);return a<50?aF(1+a,d):ag(aF,[0,d])}}function
aF(a,b){return b?a<50?cV(1+a,b[1],b[2]):ag(cV,[0,b[1],b[2]]):0}function
...
2:var
j=e[1];h[1]=b;var
g=$[1],i=cC[1]?1:(cC[1]=1,0);bE(j,b);if(i){$[1]=g;return 0}for(;;){if(0===aM[1]){cC[1]=0;$[1]=g;return 0}if(0===aM[1])throw[0,gs];aM[1]=aM[1]-1|0;var
...
1:return[0,c];case
2:var
e=c[1],k=d4(d),q=$[1];cF(e,function(a){switch(a[0]){case
0:var
r=a[1];$[1]=q;try{var
...
1:return[0,c];case
2:var
i=c[1],d=d4(e),k=$[1];cF(i,function(a){switch(a[0]){case
0:var
e=a[1];$[1]=k;try{var
...
an(a,b){return a!==ax?j(b,a):0}function
...
aa(e,b,c,d){if(e.addEventListener===ax){var
...
b=d(0),c=e[1]+16.6666666666666679-b,f=c<0?0:c;e[1]=b;l.setTimeout(a,f);return 0}}throw f}return h}),ab=kN(0),h2=l.FileReader,h5=cZ;function
ep(a){var
...
eq(a){return ab.log(a.toString())}cB[1]=function(a){eq(h6);eq(dQ(a));return dV(aY)};function
a9(a){return new
a7(E(a),bg)}var
h7=new
...
et=[0,h_];function
aB(a){throw[0,et]}var
er=a9(aq(E(h$).replace(h9,"\\$&"))),eu=new
a7("\\+",bg);function
ac(a){eu[c(fH)]=0;var
b=a.replace(eu,S);return aq(l.unescape(b))}function
G(a,b){var
e=a?a[1]:1;if(e){var
f=aq(ec(E(b)));er[c(fH)]=0;var
d=E(f);return aq(d.replace(er,E(ia).replace(h7,"$$$$")))}return aq(ec(E(b)))}var
ic=[0,ib];function
a_(a){try{var
c=a.getLen();if(0===c)var
d=ik;else{var
b=dz(a,a.getLen(),0,47);if(0===b)var
e=[0,il,a_(al(a,1,c-1|0))];else
var
f=a_(al(a,b+1|0,(c-b|0)-1|0)),e=[0,al(a,0,b),f];var
...
a$=l.location;ac(a$.hostname);ac(a$.protocol);try{}catch(f){f=s(f);if(f[1]!==bv)throw f}a_(ac(a$.pathname));cH(a$.search);ac(a$.href);var
...
ao(a,b){return[n,a[1]*b[1]-a[2]*b[2],a[1]*b[2]+a[2]*b[1]]}function
...
aD(b){var
c=ao(bb(b),D);return function(a){return ez(D,b,c,D,a)}}function
eA(a,b){var
d=b[2],e=b[1],i=a[2],f=ao(d,a[1]),c=cM(ao(f,bb(e)),D),j=cO(bb(c),c),g=ao(ao(i,d),j),h=cK(g,cL(g));return[0,cO(cM(f,e),c),h]}function
aR(a,b){var
c=cN(b,a),d=ao(a,b),e=1-aQ(d);return cK(cM(ao(d,bb(c)),c),e)}var
cP=aI;function
cQ(a){try{var
f=I(ks(a))}catch(f){f=s(f);if(f[1]===t){var
aZ=function(a){var
b=a[2],c=a[4];if(0!==b)if(200!==b)return[0,[2,[0,0,0,0,0]]];return I(c)},ap=0,ar=0,as=0,at=0,au=0,aw=0,k=0,D=0,aY=0,aK=0?aY[1]:0,aM=aw?aw[1]:0,aO=at?at[1]:function(a,b){return 1};if(au){var
X=au[1];if(k){var
aP=k[1];av(function(a){return ew(X,[0,a[1],a[2]])},aP)}var
c=[0,X]}else
if(k){var
aW=k[1],P=bH(bJ(i0)),ao=P?[0,808620462,new(P[1])()]:[0,ca,[0,0]];av(function(a){return ew(ao,[0,a[1],a[2]])},aW);var
c=[0,ao]}else
var
c=0;if(c){var
Z=c[1];if(D)var
...
c=d$(a),b=aq(F(O(c,1),aB).toLowerCase());if(Y(b,id))if(Y(b,ie)){if(Y(b,ig))if(Y(b,ih)){if(Y(b,ii))if(Y(b,ij))var
d=1,f=0;else
var
f=1;else
var
...
e=0,g=1}if(g){var
h=ac(F(O(c,5),aB)),k=function(a){return E(iu)},l=ac(F(O(c,9),k)),m=function(a){return E(iv)},n=cH(F(O(c,7),m)),o=a_(h),p=function(a){return E(iw)},i=aq(F(O(c,4),p)),q=Y(i,it)?eZ(i):e?e_:80,j=[0,ac(F(O(c,2),aB)),q,o,h,n,l],r=e?[1,j]:[0,j];return[0,r]}}throw[0,ic]},aA=function(a){function
b(a){var
b=d$(a),c=ac(F(O(b,2),aB));function
d(a){return E(ix)}var
e=aq(F(O(b,6),d));function
f(a){return E(iy)}var
...
n=0;if(!n)var
j=[0,a,0];var
ab=j[1],ad=dv(j[2],aM),ae=ad?h(ab,h(jf,bO(ad))):ab,af=bF(0),ag=af[2],ah=af[1];try{var
...
b=ar[1];return a.onprogress=m(function(a){z(b,a.loaded,a.total);return o})}return 0};an(b.upload,aS);if(c){var
B=c[1];if(ca<=B[1]){var
aj=B[2];if(typeof
$===u){var
...
ad=[0,a6(l.localStorage,eC,jn)];ab.log(ad[1]);function
eD(a){return ex(a[ad[1]])}function
eE(a){var
e=A(R.padding,0),b=A(R.border,fS)+e,c=a.width,d=a.height,f=ak(5,c/2-b);return[0,f,ak(5,d/2-b),c/2,d/2]}function
bS(a,b,c){var
...
eM(a,b){try{var
O=bA(ad[1],a)[1],m=O}catch(f){f=s(f);if(f[1]!==t)throw f;try{var
...
D=dZ(m,B),q=A(R.nodeFont,"20px sans-serif"),o=ap(bR),j=Z===o?bR[1]:ai===o?a2(bR):bR;j.style.font=q;var
...
j=d.style;j.height=h(L(ak(38,b)),jI).toString();d.style.margin=bn;d.style.borderRadius=bn;var
f=ak(6,44-b|0),k=d.style,l=h(jK,h(L(f-(f/2|0)|0),jJ));k.padding=h(L(f/2|0),l).toString();var
m=a?jL:jN;d.className=h(jM,m).toString();g(d,i);return d}var
d=p(e);d.className=cb;d.style.width=b$;var
k=d.style;k.height=h(L(8+ak(38,b)|0),jO).toString();if(a){var
...
d=[0,N];d[1]=Q(aa(e,hF,m(function(a){function
...
c=b.style;c.maxHeight=h(L(k[5]),jP).toString();g(b,a);return b},b=bN(e),J=ap(d),Y=Z===J?d[1]:ai===J?a2(d):d,M=d7(Y);if(M){var
...
ac=ad[1]===aH?jQ:h(jW,new
v(ad[1])),S=be([0,h(jR,h(new
v(k[2]),ac)).toString()],52,jS),D=bT(A(z.wikimediaCommons,"See image description on Wikimedia Commons"));D.style.left=b$;D.style.top="12px";g(S,D);g(w,S);var
...
i=em(e);g(i,d);return g(F,i)},ae=ad[1];U(A(z.language,fg),ae);if(ad[1]!==aH)U(fg,aH);if(0<T[1])g(n,F);else
...
e=al(c,1,c.getLen()-1|0),d=[0,dk,[0,[ai,function(a){function
b(a){function
...
b=[0,[0,ba,D]],r=[0,b[1]],H=L.length-1,w=0===H?[0]:kj(L,0,H);eK[1]=function(a){bd[1]=0;ab.time(dc);var
aM=x.clientWidth,aN=x.clientHeight,a$=aM!==h.width?0:aN!==h.height?0:1;if(!a$){h.width=aM;h.height=aN}var
aO=r[1],aa=aO[2],ac=aO[1],ad=L.length-1-1|0,aS=ao(bb(ac),aa),aT=0;if(!(ad<0)){var
y=aT;for(;;){k(w,y,ez(aa,ac,aS,D,i(L,y)));var
aU=y+1|0;if(ad!==y){var
y=aU;continue}break}}ab.timeEnd(dc);ab.time(fi);var
...
aX(a){b.fillStyle=a;return b.fill()}an(R.backgroundColor,aX);function
aY(a){b[c(c$)]=1;b.strokeStyle=a;return b.stroke()}an(R.boundaryColor,aY);b[c(c$)]=2;b.lineCap="round";b.strokeStyle=A(R.treeColor,cJ);var
...
ah=d[4],aj=d[3],al=d[2],am=d[1];b.beginPath();b.moveTo(e[1]*am+aj,e[2]*al+ah);b.lineTo(g[1]*am+aj,g[2]*al+ah);b.stroke()}else{var
aq=aQ(e)+1,ar=aQ(g)+1,j=[n,(g[2]*aq-e[2]*ar)/Q,(e[1]*ar-g[1]*aq)/Q],ae=d[4],af=d[3],M=d[2],s=d[1],N=cL(cN(e,j)),O=Math.atan2(e[2]-j[2],e[1]-j[1]),P=Math.atan2(g[2]-j[2],g[1]-j[1]);b.beginPath();var
...
q=e+1|0;if(g!==e){var
e=q;continue}break}}return f[1]}}(t);if(ap(p)!==ai){var
aD=ap(p),a6=Z===aD?p[1]:ai===aD?a2(p):p,aE=d7(a6);if(aE){var
W=aE[1],aF=W.width,aG=W.height,a7=aC(S,1,1,1),aH=a7/ak(aF/m,aG/l),z=aF*aH/2,B=aG*aH/2;if(1<z)if(1<B){var
...
var
aR=0}}else{var
a8=aC(S,1,1,1);if(1<a8*ak(m,l)){var
aK=ap(p);if(Z!==aK)if(ai===aK)a2(p)}}var
Y=1}if(Y)var
aP=1}var
a1=f+1|0;if(aw!==f){var
f=a1;continue}break}}ab.timeEnd(fi);return ab.log(au[1],av[1])};eL(0);l.onresize=m(function(a){var
...
f=a.clientX,g=a.clientY,c=[0,0],k=[0,N],l=aa(e,hJ,m(function(a){var
...
k=1}}if(c[1]){var
l=bS(h,f,g),m=bS(h,e,i);r[1]=[0,aR(j(aD(aC(b[1][1])),l),m),D];X(1)}aP(a);return o}),o);k[1]=Q(aa(e,hH,m(function(a){W(l);ay(k[1],W);if(c[1]){h.style.cursor=d;var
...
j=1}else
var
j=0}}return o}),o));return o});aa(h,hM,m(function(a){function
c(a){var
f=a.identifier,l=a.clientX,n=a.clientY,c=[0,0],p=aa(e,hO,m(function(a){var
...
i=1}}if(c[1]){ab.time(dc);var
k=bS(h,l,n),m=bS(h,e,g);r[1]=[0,aR(j(aD(aC(b[1][1])),k),m),D];return X(1)}return 0}return 0};an(a.changedTouches.item(d),i);var
k=d+1|0;if(e!==d){var
d=k;continue}break}}aP(a);return q}),o),g=[0,N],k=[0,N];g[1]=Q(aa(e,ef,m(function(a){var
...
e=i(C,j)[2];if(typeof
e!==u)if(dk===e[1]){var
l=e[2];eT(F,eQ,l[2],l[1]);return 0}return 0}return 0}return 0};an(a.changedTouches.item(e),m);var
n=e+1|0;if(j!==e){var
e=n;continue}break}}return o}),o));k[1]=Q(aa(e,ef,m(function(a){var
i=a.changedTouches.length-1|0,j=0;if(!(i<0)){var
e=j;for(;;){var
l=function(a){if(a.identifier===f){W(p);ay(g[1],W);ay(k[1],W);if(c[1])h.style.cursor=d;b[1]=r[1];return 0}return 0};an(a.changedTouches.item(e),l);var
m=e+1|0;if(i!==e){var
e=m;continue}break}}return q}),o));return 0}an(a.changedTouches.item(0),c);return q}),o);aa(e,ee,m(function(a){var
...
J=bA(ad[1],E)[2],C=J}catch(f){f=s(f);if(f[1]!==t)throw f;try{var
...
D=[0,N];function
F(a){aO(e.body,j);return ay(D[1],W)}D[1]=Q(aa(e,ee,m(function(a){var
...
c=new
bI();c.push("<",cb);bL(u,function(a){c.push(' type="',e2(a),at);return 0});bL(r,function(a){c.push(' name="',e2(a),at);return 0});c.push(">");var
...
c(a){return a.setItem(fl,b)}an(l.localStorage,c);ad[1]=b;O(0);eM(E,C);X(1);return q});var
