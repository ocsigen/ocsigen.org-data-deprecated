...
di=123,n=254,fr=108,fs=".jpg",fq=-0.1,fC=",",at='"',_=16777215,c2="=",ar="function",fR=0.5,c_=65599,fb="jsError",ce="POST",bp=115,fp="&",fa="center",dh=120,fQ="block",e$=",\n",c1="\n",c9="]",dg=117,fo="overlay",cd=126925477,fn="0000",f="0",c8=248,b7=4204112,fP="fd ",bn="2px",aj="src/core/lwt.ml",fO="table-cell",e_="meeting-point-38.png",df="x",cc="36px",aH="en",bg="g",b0=1073741823,fB=": ",aG=105,bk="object",fA="%d",e9=443,bj=110,fN=-88,b2="text",b6="'",bZ="int_of_string",fM="table",fz=982028505,fm="move",e8="http://",bo="e",fL="1",ca=891486873,cb="button",ah="-",b5=-48,fl="globe-38.png",c7=" : file already exists",de="text on",e7="off",dd="38px",dn=101,e6=0.1,fK="index out of bounds",fk="hyp_lang",c0=125,x=255,fj="wikipedia-38.png",fJ="}",fi='Content-Disposition: form-data; name="',Z=250,fI=1.41421356237309515,cZ=2147483,cY="on",K="auto",e5=-550809787,ai=246,c6=102,e4="0px",e3="--",fh="draw",c5=870530776,d="",dc="transform",b4=781515420,aS=100,fy="info-38.png",b$="48px",dm=103,fx=936573133,y="absolute",dl="_blank",fg=1e3,fw=0.25,aU=".",bi="+",b_=65535,ff="In English",fv="ocsigen-powered.png",db="f",dk=3654627,fe="80%",fu=124,fH=785140586,b3="?",fd=-32,c4=111,bm="string",R=" ",c3="px",bl="pointer",ft="\\u",fG="lastIndex",da="hidden",cX="middle",aT=":",fc="nan",cW=116,b1="\r\n",c$="lineWidth",P="100%",fF=65520,fE="%.12g",as="/",b9=114,bh="#",e2=0.95,dj="nowrap",fD="commons-38.png",b8="null",u="number",aI;if(!aI)aI={};(function(){"use strict";function
...
b=h[a];return typeof
b===bm?b:ft+(fn+a.charCodeAt(0).toString(16)).slice(-4)})+at:at+a+at}function
m(a,b){var
...
bk:if(!c)return b8;e+=l;d=[];if(Object.prototype.toString.apply(c)==="[object Array]"){j=c.length;for(g=0;g<j;g+=1)d[g]=m(g,c)||b8;f=d.length===0?"[]":e?"[\n"+e+d.join(e$+e)+c1+k+c9:"["+d.join(fC)+c9;e=k;return f}if(i&&typeof
i===bk){j=i.length;for(g=0;g<j;g+=1){h=i[g];if(typeof
h===bm){f=m(h,c);if(f)d.push(n(h)+(e?fB:aT)+f)}}}else
for(h
in
c)if(Object.prototype.hasOwnProperty.call(c,h)){f=m(h,c);if(f)d.push(n(h)+(e?fB:aT)+f)}f=d.length===0?"{}":e?"{\n"+e+d.join(e$+e)+c1+k+fJ:"{"+d.join(fC)+fJ;e=k;return f}}if(typeof
aI.stringify!==ar)aI.stringify=function(a,b,c){var
f;e=d;l=d;if(typeof
c===u)for(f=0;f<c;f+=1)l+=R;else
if(typeof
...
f9(){f8(w[4],new
B(fK))}B.prototype={string:null,bytes:null,fullBytes:null,array:null,len:null,last:0,toJsString:function(){var
...
b=this.bytes;if(b==null)b=this.toBytes();return a<this.last?b.charCodeAt(a):0},safeGet:function(a){if(this.len==null)this.toBytes();if(a<0||a>=this.len)f9();return this.get(a)},set:function(a,b){var
c=this.array;if(!c){if(this.last==a){this.bytes+=String.fromCharCode(b&x);this.last++;return 0}c=this.toArray()}else
if(this.bytes!=null)this.bytes=this.fullBytes=this.string=null;c[a]=b&x;return 0},safeSet:function(a,b){if(this.len==null)this.toBytes();if(a<0||a>=this.len)f9();this.set(a,b)},fill:function(a,b,c){if(a>=this.last&&this.last&&c==0)return;var
...
fT(){aW(fK)}function
kg(a,b){if(b<0||b>=a.length-1)fT();return a[b+1]}function
kh(a,b,c){if(b<0||b>=a.length-1)fT();a[b+1]=c;return 0}function
ki(a,b,c){return[0].concat(a.slice(b+1,b+1+c))}function
...
x:var
d=kw(a,b);if(d!=0)return d;break;default:if(a.length!=b.length)return a.length<b.length?-1:1;if(a.length>1)e.push(a,b,1)}}else
return 1}else
if(b
instanceof
B||b
...
kk(a,b){return bq(a,b,true)}function
kl(){return 0}function
fS(a){this.bytes=d;this.len=a}fS.prototype=new
B();function
fV(a){if(a<0)aW("String.create");return new
fS(a)}function
kn(a,b){return+(bq(a,b,false)==0)}function
ko(a,b,c,d){a.fill(b,c,d)}function
dr(a){a=a.toString();var
e=a.length;if(e>31)aW("format_int: format too long");var
b={justify:bi,signstyle:ah,filler:R,alternate:false,base:0,signedconv:false,width:0,uppercase:false,sign:1,prec:-1,conv:db};for(var
d=0;d<e;d++){var
...
fL:case"2":case"3":case"4":case"5":case"6":case"7":case"8":case"9":b.width=0;while(c=a.charCodeAt(d)-48,c>=0&&c<=9){b.width=b.width*10+c;d++}d--;break;case
...
e=g;e<a.width;e++)c+=R;return new
v(c)}function
kp(a,b){var
c,g=dr(a),e=g.prec<0?6:g.prec;if(b<0){g.sign=-1;b=-b}if(isNaN(b)){c=fc;g.filler=R}else
...
kq(a,b){if(a.toString()==fA)return new
v(d+b);var
...
aJ();cj.mk(d,new
aJ());function
S(a){ds(w[2],a)}function
f6(a){a=a
instanceof
B?a.toString():a;S(a+": No such file or directory")}function
cg(a){var
b=cj;for(var
...
br(a){a=a
instanceof
B?a.toString():a;if(a.charCodeAt(0)!=47)a=km+a;var
...
fX(a){if(!isFinite(a)){if(isNaN(a))return[x,1,0,fF];return a>0?[x,0,0,32752]:[x,0,0,fF]}var
...
if(e===+e){f=t(f,fX(e));h--;break}}f=s(f);return f&b0}}();function
kE(a){return[a[3]>>8,a[3]&x,a[2]>>16,a[2]>>8&x,a[2]&x,a[1]>>16,a[1]>>8&x,a[1]&x]}function
kv(e,b,c){var
d=0;function
...
kC(a){return[x,a&_,a>>24&_,a>>31&b_]}function
kD(a,b){var
...
fY(a){a[3]=a[3]<<1|a[2]>>23;a[2]=(a[2]<<1|a[1]>>23)&_;a[1]=a[1]<<1&_}function
kA(a){a[1]=(a[1]>>>1|a[2]<<23)&_;a[2]=(a[2]>>>1|a[3]<<23)&_;a[3]=a[3]>>>1}function
kG(a,b){var
e=0,d=a.slice(),c=b.slice(),f=[x,0,0,0];while(fZ(d,c)>0){e++;fY(c)}while(e>=0){e--;fY(f);if(fZ(d,c)>=0){f[1]++;d=kD(d,c)}kA(c)}return[0,f,d]}function
kF(a){return a[1]|a[2]<<24}function
ky(a){return a[3]<<16<0}function
kB(a){var
b=-a[1],c=-a[2]+(b>>24),d=-a[3]+(c>>24);return[x,b&_,c&_,d&b_]}function
kx(a,b){var
c=dr(a);if(c.signedconv&&ky(b)){c.sign=-1;b=kB(b)}var
e=d,j=kC(c.base),i="0123456789abcdef";do{var
h=kG(b,j);b=h[1];e=i.charAt(kF(h[2]))+e}while(!kz(b));if(c.prec>=0){c.filler=R;var
g=c.prec-e.length;if(g>0)e=bt(g,f)+e}return dq(c,e)}function
k5(a){var
...
kI(a){var
g=k5(a),f=g[0],h=g[1],d=g[2],i=-1>>>0,e=a.get(f),c=f4(e);if(c<0||c>=d)cf(bZ);var
b=c;for(;;){f++;e=a.get(f);if(e==95)continue;c=f4(e);if(c<0||c>=d)break;b=d*b+c;if(b>i)cf(bZ)}if(f!=a.getLen())cf(bZ);b=h*b;if(d==10&&(b|0)!=b)cf(bZ);return b|0}function
kJ(a){return+(a>31&&a<127)}function
kK(a,b,c){return a.apply(b,c.slice(1))}function
kL(a){return a.getFullBytes()}function
kM(){var
...
kN(a){if(!ch.all.test(a))return a;return a.replace(ch.amp,"&amp;").replace(ch.lt,"&lt;").replace(ch.quot,"&quot;")}function
kO(){var
...
kS(a,b){return+(bq(a,b,false)<=0)}function
kT(a,b){var
d=[0];for(var
...
dp(n(h,c))}}();function
f0(a){if(!a.opened)S("Cannot flush a closed channel");if(a.buffer==d)return 0;if(a.output)switch(a.output.length){case
...
f=a.toString(),h=br(a);if(d.rdonly&&d.wronly)S(f+" : flags Open_rdonly and Open_wronly are not compatible");if(d.text&&d.binary)S(f+" : flags Open_text and Open_binary are not compatible");if(lc(a)){if(le(a))S(f+" : is a directory");if(d.create&&d.excl)S(f+c7);var
g=w.fd_last_idx?w.fd_last_idx:0,e=cg(h);if(d.truncate)e.truncate();return bu(g+1,e.content(),d)}else
if(d.create){var
g=w.fd_last_idx?w.fd_last_idx:0;fW(a,[]);var
e=cg(h);return bu(g+1,e.content(),d)}else
f6(a)}bu(0,[]);bu(1,[]);bu(2,[]);function
kV(a){var
b=w.fds[a];if(b.flags.wronly)S(fP+a+" is writeonly");return{data:b,fd:a,opened:true}}function
...
b;switch(a){case
1:b=lk;break;case
2:b=dt;break;default:b=k9}var
e=w.fds[a];if(e.flags.rdonly)S(fP+a+" is readonly");var
...
f1(a,b,c,d){if(!a.opened)S("Cannot output to a closed channel");var
f;if(c==0&&b.getLen()==d)f=b;else{f=fV(d);fU(b,c,f,0,d)}var
e=f.toString(),g=e.lastIndexOf(c1);if(g<0)a.buffer+=e;else{a.buffer+=e.substr(0,g+1);f0(a);a.buffer+=e.substr(g+1)}}function
f3(a){return new
B(a)}function
kY(a,b){var
c=f3(String.fromCharCode(b));f1(a,c,0,1)}function
k6(){f5(w[6])}function
kZ(a,b){if(b==0)k6();return a%b}function
k1(a,b){return+(bq(a,b,false)!=0)}function
k2(a){return+(a
instanceof
Array)}function
k3(a,b){a[0]=b;return 0}function
k4(a){return a
instanceof
Array?a[0]:fg}function
k7(a,b){w[a+1]=b}var
f2={};function
k8(a,b){f2[a.toString()]=b;return 0}function
k_(a,b){var
...
instanceof
b.Error)return[0,k0(fb),a];return[0,w[3],new
v(String(a))]}var
i=kg,k=kh,aE=fU,bX=kk,ae=fV,cS=kp,bU=kq,cR=fW,eY=kI,cT=kJ,E=kL,e1=kN,aq=kQ,bf=kR,r=kT,eU=f0,eT=kW,eW=kY,e0=kZ,eX=bs,c=f3,ap=k4,a=k7,eV=k8,Y=k$,eZ=ld,bY=lg,ag=lh,s=lj;function
...
dR=[0,c("Out_of_memory")],bv=[0,c("Failure")],du=[0,c("Invalid_argument")],t=[0,c("Not_found")],dT=[0,c("Match_failure")],dS=[0,c("Stack_overflow")],C=[0,c("Assert_failure")],dU=[0,c("Undefined_recursive_module")],cu=c('File "%s", line %d, characters %d-%d: %s'),eg=c(cb),eO=[n,fw,0],D=[n,1,0],ba=[n,0,0];a(11,dU);a(10,C);a(9,[0,c("Sys_blocked_io")]);a(8,dS);a(7,dT);a(6,t);a(5,[0,c("Division_by_zero")]);a(4,[0,c("End_of_file")]);a(3,du);a(2,bv);a(1,[0,c("Sys_error")]);a(0,dR);var
gb=c(fE),ga=c(aU),f_=c("true"),f$=c("false"),gc=c("Pervasives.do_at_exit"),gh=c("\\b"),gi=c("\\t"),gj=c("\\n"),gk=c("\\r"),gg=c("\\\\"),gf=c("\\'"),go=c("String.contains_from"),gn=c(d),gm=c("String.blit"),gl=c("String.sub"),gq=c("Queue.Empty"),gs=c("CamlinternalLazy.Undefined"),gv=c("Buffer.add: cannot grow buffer"),gL=c(d),gM=c(d),gP=c(fE),gQ=c(at),gR=c(at),gN=c(b6),gO=c(b6),gK=c(fc),gI=c("neg_infinity"),gJ=c("infinity"),gH=c(aU),gG=c("printf: bad positional specification (0)."),gF=c("%_"),gE=[0,c("printf.ml"),143,8],gC=c(b6),gD=c("Printf: premature end of format string '"),gy=c(b6),gz=c(" in format string '"),gA=c(", at char number "),gB=c("Printf: bad conversion %"),gw=c("Sformat.index_of_int: negative argument "),gW=c(d),gX=c(", %s%s"),hb=[1,1],hc=c("%s\n"),hd=c("(Program not linked with -g, cannot print stack backtrace)\n"),g7=c("Raised at"),g_=c("Re-raised at"),g$=c("Raised by primitive operation at"),ha=c("Called from"),g8=c('%s file "%s", line %d, characters %d-%d'),g9=c("%s unknown location"),g2=c("Out of memory"),g3=c("Stack overflow"),g4=c("Pattern matching failed"),g5=c("Assertion failed"),g6=c("Undefined recursive module"),gY=c("(%s%s)"),gZ=c(d),g0=c(d),g1=c("(%s)"),gV=c(fA),gT=c("%S"),gU=c("_"),he=c(df),kd=c("OCAMLRUNPARAM"),kb=c("CAMLRUNPARAM"),hf=c(d),hv=[0,c(aj),814,20],hw=[0,c(aj),816,8],hu=[0,c(aj),785,16],hs=[0,c(aj),670,20],ht=[0,c(aj),673,8],hq=[0,c(aj),648,20],hr=[0,c(aj),651,8],hn=[0,c(aj),498,8],hm=[0,c(aj),487,9],hl=c("Lwt.wakeup_result"),hi=c("Fatal error: exception "),hh=c("Lwt.Canceled"),ho=[0,0],hB=c("Js.Error"),hC=c(fb),hY=c("canvas"),hW=c("dt"),hV=c("dd"),hU=c("img"),hT=c("a"),hS=c("div"),hR=c("li"),hQ=c("dl"),hP=c("ul"),hD=c("click"),hF=c("mouseup"),hH=c("mousemove"),hJ=c("keydown"),hK=c("touchstart"),hM=c("touchmove"),hO=c("touchend"),hX=c("Dom_html.Canvas_not_available"),h3=c("browser can't read file: unimplemented"),h2=[0,c("file.ml"),131,15],h0=c("can't retrieve file name: not implemented"),h5=c("Exception during Lwt.async: "),h7=c("[\\][()\\\\|+*.?{}^$]"),ij=[0,c(d),0],ik=c(d),iy=c(d),iz=c(bh),iH=c(d),iA=c(b3),iG=c(d),iB=c(as),iC=c(as),iF=c(aT),iD=c(d),iE=c(e8),iI=c(d),iJ=c(bh),iR=c(d),iK=c(b3),iQ=c(d),iL=c(as),iM=c(as),iP=c(aT),iN=c(d),iO=c("https://"),iS=c(d),iT=c(bh),iY=c(d),iU=c(b3),iX=c(d),iV=c(as),iW=c("file://"),ix=c(d),iw=c(d),iv=c(d),iu=c(d),it=c(d),is=c(d),il=c(c2),im=c(fp),ic=c("file"),id=c("file:"),ie=c("http"),ig=c("http:"),ih=c("https"),ii=c("https:"),h$=c("%2B"),h9=c("Url.Local_exn"),h_=c(bi),ia=c("Url.Not_an_http_protocol"),io=c("^([Hh][Tt][Tt][Pp][Ss]?)://([0-9a-zA-Z.-]+|\\[[0-9a-zA-Z.-]+\\]|\\[[0-9A-Fa-f:.]+\\])?(:([0-9]+))?/([^\\?#]*)(\\?([^#]*))?(#(.*))?$"),iq=c("^([Ff][Ii][Ll][Ee])://([^\\?#]*)(\\?([^#]*))?(#(.*))?$"),jd=c(ce),jf=c("multipart/form-data; boundary="),jg=c(ce),jh=[0,c(ce),[0,c("application/x-www-form-urlencoded")],cd],ji=[0,c(ce),0,cd],jj=c("GET"),je=c(b3),i_=c(c2),i$=c(c2),ja=c(fp),i6=c('"; filename="'),i7=c(fi),i4=c(b1),i5=c(e3),i8=c('"\r\n\r\n'),i9=c(fi),i2=c("--\r\n"),i3=c(e3),i1=c("js_of_ocaml-------------------"),i0=[0,c("xmlHttpRequest.ml"),79,2],jb=c("XmlHttpRequest.Wrong_headers"),j8=c(fy),j9=c(fl),j_=[0,[0,c("Fran\xc3\xa7ais"),c("fr")],[0,[0,c("English"),c(aH)],0]],j$=c(e_),j0=[n,0,0],j1=[n,e6,0],j2=[n,0,0],j3=[n,0,e6],j4=[n,0,0],j5=[n,fq,0],j6=[n,0,0],j7=[n,0,fq],ka=c(fv),jT=c(".wikipedia.org/wiki/"),jU=c(e8),jO=c(c3),jW=c(fs),jX=c("images/"),jP=c(d),jV=c("?uselang="),jQ=c("http://commons.wikimedia.org/wiki/File:"),jR=c(fD),jS=c(fj),jH=c(c3),jI=c("px 3px"),jJ=c("px 3px "),jK=c(cY),jM=c(e7),jL=c("filled_button "),jN=c(c3),jF=c(cY),jG=c(e7),jE=c("image_info.json"),jz=[0,0,0,0],jA=[n,-1,0],jy=[0,c("hypertree.ml"),929,2],jx=c("<TITLE>"),jw=c(d),jr=c(fs),js=c("thumbnails/"),jo=c("messages.json"),jl=c("icons/"),jk=[0,c(fD),[0,c(fj),[0,c(fy),[0,c(e_),[0,c(fl),[0,c(fv),0]]]]]],jq=c("tree.json"),jt=c("\n"),ju=c("[^ ]"),jv=c("[|]"),jY=c('<h1>A tree of animals</h1> This <a target="_blank" href="http://en.wikipedia.org/wiki/Phylogenetic_tree"><em>phylogenetic</em> tree</a> displays the relationships among animals.<h2>Usage</h2>Browse the tree by dragging it with the mouse. Click on any image to display a larger version.<h2>Credits</h2>This software and the images it uses are under free licenses. Images are from <a target="_blank" href="http://commons.wikimedia.org/wiki/Main_Page">Wikimedia Commons</a>.  You can click on each image for details.  The software has been written by J\xc3\xa9r\xc3\xb4me Vouillon (CNRS).');function
aX(a){throw[0,bv,a]}function
aK(a){throw[0,du,a]}function
ck(a,b){return kS(a,b)?a:b}function
ak(a,b){return kt(a,b)?a:b}function
...
dv(a,b){if(a){var
c=a[1];return[0,c,dv(a[2],b)]}return b}kV(0);eT(1);var
aY=eT(2);function
dw(a,b){return f1(a,b,0,b.getLen())}function
dx(a){return dw(aY,a)}function
cl(a){var
b=kX(0);for(;;){if(b){var
c=b[2],d=b[1];try{eU(d)}catch(f){}var
b=c;continue}return 0}}eV(gc,cl);function
gd(a,b){return eW(a,b)}function
dy(a){return eU(a)}function
bx(a,b){var
...
aZ(a,b){var
c=ae(a);ko(c,0,a,b);return c}function
al(a,b,c){if(0<=b)if(0<=c)if(!((a.getLen()-c|0)<b)){var
d=ae(c);aE(a,b,d,0,c);return d}return aK(gl)}function
bB(a,b,c,d,e){if(0<=e)if(0<=b)if(!((a.getLen()-e|0)<b))if(0<=d)if(!((c.getLen()-e|0)<d))return aE(a,b,c,d,e);return aK(gm)}function
a0(d,b){if(b){var
a=b[1],g=[0,0],f=[0,0],h=b[2];av(function(a){g[1]++;f[1]=f[1]+a.getLen()|0;return 0},b);var
e=ae(f[1]+eX(d.getLen(),g[1]-1|0)|0);aE(a,0,e,0,a.getLen());var
c=[0,a.getLen()];av(function(a){aE(d,0,e,c[1],d.getLen());c[1]=c[1]+d.getLen()|0;aE(a,0,e,c[1],a.getLen());c[1]=c[1]+a.getLen()|0;return 0},h);return e}return gn}function
dz(a,b,c,d){var
e=c;for(;;){if(b<=e)throw[0,t];if(a.safeGet(e)===d)return e;var
e=e+1|0;continue}}var
cn=la(0),co=(1<<(cn-10|0))-1|0,a1=eX(cn/8|0,co)-1|0,gr=[0,gq],gt=[0,gs];function
gu(a){throw[0,gt]}function
a2(a){var
c=a[0+1];a[0+1]=gu;try{var
b=j(c,0);a[0+1]=b;k3(a,Z)}catch(f){f=s(f);a[0+1]=function(a){throw f};throw f}return b}function
cp(a){var
...
cs(a){return 0<=a?a:aX(h(gw,L(a)))}function
dD(a,b){return cs(a+b|0)}var
gx=1;function
dE(a){return dD(gx,a)}function
dF(a){return al(a,0,a.getLen())}function
dG(a,b,c){var
d=h(gz,h(a,gy)),e=h(gA,h(L(b),d));return aK(h(gB,h(aZ(1,c),e)))}function
a4(a,b,c){return dG(dF(a),b,c)}function
bC(a){return aK(h(gD,h(dF(a),gC)))}function
aw(g,b,c,d){function
...
a=h(a+1|0),f=k;continue}throw[0,C,gE]}a3(e,j);var
...
r=i.safeGet(q)+fN|0;if(32<r>>>0)var
o=1;else
switch(r){case
0:case
12:case
...
if(36===f)return 0===e?aX(gG):z(b,[0,cs(e-1|0)],d+1|0);return z(b,0,c)}}function
...
fr:case
bj:var
as=k.safeGet(a+1|0)+fN|0;if(!(32<as>>>0))switch(as){case
0:case
12:case
17:case
23:case
...
au=av,$=1}if(!$)var
aX=l(g,f),au=kx(aw(k,m,P,c),aX);return o(H(g,f),au,P+1|0)}var
...
ab=0;else
var
ah=[0,eY(al(D,q,(D.getLen()-q|0)-1|0)),R],ab=1;else{if(45===S){var
...
r=C}}var
aq=h(gO,h(r,gN))}return o(H(g,f),aq,a+1|0);case
66:case
98:var
aQ=a+1|0,aR=l(g,f)?f_:f$;return o(H(g,f),aR,aQ);case
40:case
di:var
O=l(g,f),ao=z(dI(n),k,a+1|0);if(di===n){var
L=cp(O.getLen()),ai=function(a,b){a3(L,b);return a+1|0};dJ(O,function(a,b,c){if(a)cr(L,gF);else
...
41:return o(f,gL,a+1|0);case
44:return o(f,gM,a+1|0);case
70:var
Y=l(g,f);if(0===c)var
ar=gP;else{var
...
b(a){return d}var
c=0;return function(a){return dN(c,b,gd,dw,dy,e,a)}}function
gS(a){return cp(2*a.getLen()|0)}function
T(a){function
b(a){var
b=cq(a);a[2]=0;return b}return dN(1,gS,a3,cr,function(a){return 0},b,a)}var
ct=[0,0];function
cv(a,b){var
c=a[b+1];if(k2(c)){if(ap(c)===252)return j(T(gT),c);if(ap(c)===253){var
e=cS(gb,c),d=0,g=e.getLen();for(;;){if(g<=d)return h(e,ga);var
f=e.safeGet(d),i=48<=f?58<=f?0:1:45===f?1:0;if(i){var
d=d+1|0;continue}return e}}return gU}return j(T(gV),c)}function
dP(a,b){if(a.length-1<=b)return gW;var
c=dP(a,b+1|0),d=cv(a,b);return z(T(gX),d,c)}function
dQ(a){var
b=ct[1];for(;;){if(b){var
q=b[2],r=b[1];try{var
s=j(r,a),d=s}catch(f){var
d=0}if(d)return d[1];var
b=q;continue}if(a[1]===dR)return g2;if(a[1]===dS)return g3;if(a[1]===dT){var
e=a[2],k=e[3],t=e[2],u=e[1];return bV(T(cu),u,t,k,k+5|0,g4)}if(a[1]===C){var
f=a[2],l=f[3],v=f[2],w=f[1];return bV(T(cu),w,v,l,l+6|0,g5)}if(a[1]===dU){var
g=a[2],m=g[3],x=g[2],y=g[1];return bV(T(cu),y,x,m,m+6|0,g6)}var
i=a.length-1,A=a[0+1][0+1];if(2<i>>>0)var
n=dP(a,2),o=cv(a,1),c=z(T(gY),o,n);else
switch(i){case
1:var
c=g0;break;case
2:var
p=cv(a,1),c=j(T(g1),p);break;default:var
c=gZ}return h(A,c)}}function
dV(a){var
h=kl(ks(0));if(h){var
d=h[1],f=d.length-1-1|0,p=0;if(!(f<0)){var
c=p;for(;;){if(k1(i(d,c),hb)){var
b=i(d,c),k=0===b[0]?b[1]:b[1],e=k?0===c?g7:g_:0===c?g$:ha;if(0===b[0])var
l=b[5],m=b[4],n=b[3],o=b[2],g=bV(T(g8),e,o,n,m,l);else
var
g=j(T(g9),e);z(dO(a),hc,g)}var
q=c+1|0;if(f!==c){var
c=q;continue}break}}return 0}return j(dO(a),hd)}function
dW(a){ct[1]=[0,a,ct[1]];return 0}32===cn;try{var
ke=eZ(kd),cw=ke}catch(f){f=s(f);if(f[1]!==t)throw f;try{var
kc=eZ(kb),dX=kc}catch(f){f=s(f);if(f[1]!==t)throw f;var
dX=hf}var
cw=dX}var
dA=cw.getLen(),hg=82,dB=0;if(0<=0)if(dA<dB)var
bW=0;else
try{dz(cw,dA,dB,hg);var
gp=1,cx=gp,bW=1}catch(f){f=s(f);if(f[1]!==t)throw f;var
cx=0,bW=1}else
var
bW=0;if(!bW)var
cx=aK(go);var
bD=[ai,function(a){var
o=lf(0),b=[0,r(55,0),0],j=0===o.length-1?[0,0]:o,l=j.length-1,p=0;if(!0){var
d=p;for(;;){k(b[1],d,d);var
u=d+1|0;if(54!==d){var
d=u;continue}break}}var
f=[0,he],m=54+ak(55,l)|0,q=0;if(!(m<0)){var
c=q;for(;;){var
n=c%55|0,s=f[1],g=h(s,L(i(j,e0(c,l))));f[1]=kU(g,0,g.getLen());var
...
cy(a,b){return 3<=a.length-1?ku(10,aS,a[3],b)&(a[2].length-1-1|0):e0(kv(10,aS,b),a[2].length-1)}function
dZ(a,b){var
...
d0(a){var
b=[];li(b,[0,b,b]);return b}var
cz=[0,hh],$=[0,0];function
cA(a){var
c=a[1];if(3===c[0]){var
d=c[1],b=cA(d);if(b!==d)a[1]=[3,b];return b}return a}function
am(a){return cA(a)}var
cB=[0,function(a){dx(hi);dx(dQ(a));eW(aY,10);dV(aY);dy(aY);cl(0);return lb(2)}];function
d1(a,b){try{var
...
hj(b,c,d){return bY(cU(0,b,c,d))}function
ll(b,c){return bY(af(0,b,c))}function
cV(a,b,c){var
...
hk(b,c){return bY(cV(0,b,c))}function
lm(b){return bY(aF(0,b))}function
bE(a,b){var
c=1===b[0]?b[1][1]===cz?(hk(a[4],0),1):0:0;return hj(b,a[2],0)}var
...
2:var
j=e[1];h[1]=b;var
g=$[1],i=cC[1]?1:(cC[1]=1,0);bE(j,b);if(i){$[1]=g;return 0}for(;;){if(0===aM[1]){cC[1]=0;$[1]=g;return 0}if(0===aM[1])throw[0,gr];aM[1]=aM[1]-1|0;var
c=aM[2],d=c[2];if(d===c)aM[2]=0;else
c[2]=d[2];var
f=d[1];bE(f[1],f[2]);continue}}return aK(hl)}function
...
e=d[1];c[1]=b;return bE(e,b)}throw[0,C,hn]}function
...
i===u?h:typeof
h===u?i:[2,i,h];c[4]=p;return 0}d[1]=e;return bE(c,e)}throw[0,C,hm];case
1:return cE(k,a);default:throw[0,C,hq]}});return k;case
3:throw[0,C,hr];default:return j(b,c[1])}}function
...
1:return cE(d,a);default:throw[0,C,hs]}});return d;case
3:throw[0,C,ht];default:var
f=c[1];try{var
...
1:throw b[1];case
2:return 0;case
3:throw[0,C,hu];default:return[0,b[1]]}}var
hx=[0,function(a){return 0}],U=d0(0),hy=[0,0];function
hz(a){var
e=1-(U[2]===U?1:0);if(e){var
b=d0(0);b[1][2]=U[2];U[2][1]=b[1];b[1]=U[1];U[1][2]=b;U[1]=U;U[2]=U;hy[1]=0;var
c=b[2];for(;;){var
d=c!==b?1:0;if(d){if(c[4])a5(c[3],0);var
c=c[2];continue}return d}}return e}function
d8(c,b){if(b){var
d=b[2],a=b[1],e=function(a){return d8(c,d)};return d5(j(c,a),e)}return hp}var
...
d_(a){return a}var
d$=l.Math,ea=[0,hB],hA=l.Date;eV(hC,[0,ea,{}][0+1]);function
eb(a){return l.escape(a)}dW(function(a){return a[1]===ea?[0,new
...
m(d){return V(bf(function(a){if(a){var
...
d=[0,c,a,[0]];return function(a,b){return kK(d,a,b)}};e.attachEvent(f,g);return function(a){return e.detachEvent(f,g)}}e.addEventListener(b,c,d);return function(a){return e.removeEventListener(b,c,d)}}function
W(a){return j(a,0)}var
ec=kO(0)|0,hE=az(hD),hG=az(hF),hI=az(hH),ed=az(hJ),hL=az(hK),hN=az(hM),ee=az(hO),bK="2d",e=l.document;function
bL(a,b){return a?j(b,a[1]):0}function
a8(a,b){return a.createElement(b.toString())}function
aA(a,b){return a8(a,b)}var
ef=[0,fH];function
eh(a){return aA(a,hP)}function
ei(a){return aA(a,hQ)}function
ej(a){return aA(a,hR)}function
p(a){return aA(a,hS)}function
bM(a){return aA(a,hT)}function
bN(a){return aA(a,hU)}function
ek(a){return a8(a,hV)}function
el(a){return a8(a,hW)}var
em=[0,hX];function
en(a){var
b=aA(a,hY);if(1-(b.getContext==N?1:0))return b;throw[0,em]}bJ(l.HTMLElement)===ax;function
aP(b){function
a(a){return b.stopPropagation()}function
c(a){return b.cancelBubble=o}return a6(b.stopPropagation,c,a)}var
hZ=kP(function(a){var
...
hA().getTime()},e=[0,d(0)];return function(a){var
b=d(0),c=e[1]+16.6666666666666679-b,f=c<0?0:c;e[1]=b;l.setTimeout(a,f);return 0}}throw f}return h}),ab=kM(0),h1=l.FileReader,h4=cZ;function
eo(a){var
b=bF(0),c=b[1],d=[0,0],f=0,g=b[2];function
e(a,b){var
c=cZ<a?[0,h4,a-cZ]:[0,a,0],f=c[2],h=c[1],i=f==0?function(a){return a5(g,a)}:function(a){return e(f,a)};d[1]=[0,l.setTimeout(bf(i),h*fg)];return 0}e(f,0);cG(c,function(a){var
b=d[1];return b?l.clearTimeout(b[1]):0});return c}hx[1]=function(a){return 1===a?(l.setTimeout(bf(hz),0),0):0};function
ep(a){return ab.log(a.toString())}cB[1]=function(a){ep(h5);ep(dQ(a));return dV(aY)};function
a9(a){return new
a7(E(a),bg)}var
h6=new
a7("[$]",bg),h8=a9(h7);function
er(a,b){return b.split(aZ(1,a).toString())}var
es=[0,h9];function
aB(a){throw[0,es]}var
eq=a9(aq(E(h_).replace(h8,"\\$&"))),et=new
a7("\\+",bg);function
ac(a){et[c(fG)]=0;var
b=a.replace(et,R);return aq(l.unescape(b))}function
G(a,b){var
e=a?a[1]:1;if(e){var
f=aq(eb(E(b)));eq[c(fG)]=0;var
d=E(f);return aq(d.replace(eq,E(h$).replace(h6,"$$$$")))}return aq(eb(E(b)))}var
ib=[0,ia];function
a_(a){try{var
c=a.getLen();if(0===c)var
d=ij;else{var
b=dz(a,a.getLen(),0,47);if(0===b)var
e=[0,ik,a_(al(a,1,c-1|0))];else
var
f=a_(al(a,b+1|0,(c-b|0)-1|0)),e=[0,al(a,0,b),f];var
d=e}}catch(f){f=s(f);if(f[1]===t)return[0,a,0];throw f}return d}function
bO(a){return a0(im,aL(function(a){var
b=a[1],c=h(il,G(0,a[2]));return h(G(0,b),c)},a))}function
cH(a){var
...
var
c=ax;return a6(c,aB,e)},h=e([0,a6(O(d,c),aB,g),a],f)}catch(f){f=s(f);if(f[1]===es){var
...
1:var
c=a[1],i=c[6],j=c[5],k=c[2],v=c[3],w=c[1],x=Y(i,iI)?h(iJ,G(0,i)):iR,y=j?h(iK,bO(j)):iQ,z=h(y,x),A=h(iM,h(a0(iL,aL(function(a){return G(0,a)},v)),z)),B=e9===k?iN:h(iP,L(k)),C=h(B,A);return h(iO,h(G(0,w),C));case
2:var
d=a[1],l=d[4],m=d[3],D=d[1],E=Y(l,iS)?h(iT,G(0,l)):iY,F=m?h(iU,bO(m)):iX,H=h(F,E);return h(iW,h(a0(iV,aL(function(a){return G(0,a)},D)),H));default:var
b=a[1],e=b[6],f=b[5],g=b[2],n=b[3],o=b[1],p=Y(e,iy)?h(iz,G(0,e)):iH,q=f?h(iA,bO(f)):iG,r=h(q,p),s=h(iC,h(a0(iB,aL(function(a){return G(0,a)},n)),r)),t=80===g?iD:h(iF,L(g)),u=h(t,s);return h(iE,h(G(0,o),u))}}var
a$=l.location;ac(a$.hostname);ac(a$.protocol);try{}catch(f){f=s(f);if(f[1]!==bv)throw f}a_(ac(a$.pathname));cH(a$.search);ac(a$.href);var
iZ=l.FormData;function
ev(a,b){if(ca<=a[1]){var
d=a[2];d[1]=[0,b,d[1]];return 0}var
e=a[2],c=b[2],f=b[1];return b4<=c[1]?e.append(f.toString(),c[2]):e.append(f.toString(),c[2])}var
jc=[0,jb];function
cI(a){return h(jl,a).toString()}var
cJ="#794c0d";function
ew(a){return F(a,function(a){return new
bI()})}var
Q=ew(l.hyp);function
...
ex(a,b,c){return[n,a[1]*b[1]-a[2]*b[2]+c[1],a[1]*b[2]+a[2]*b[1]+c[2]]}function
cO(a,b){var
c=aQ(b);return[n,(a[1]*b[1]+a[2]*b[2])/c,(a[2]*b[1]-a[1]*b[2])/c]}function
ey(a,b,c,d,e){var
f=ex(c,e,d);return cO(ex(a,e,b),f)}function
aD(b){var
c=ao(bb(b),D);return function(a){return ey(D,b,c,D,a)}}function
ez(a,b){var
...
cP=aI;function
cQ(a){try{var
f=I(kr(a))}catch(f){f=s(f);if(f[1]===t){var
aZ=function(a){var
...
X=au[1];if(k){var
aP=k[1];av(function(a){return ev(X,[0,a[1],a[2]])},aP)}var
c=[0,X]}else
if(k){var
aW=k[1],P=bH(bJ(iZ)),ao=P?[0,808620462,new(P[1])()]:[0,ca,[0,0]];av(function(a){return ev(ao,[0,a[1],a[2]])},aW);var
c=[0,ao]}else
var
c=0;if(c){var
Z=c[1];if(D)var
_=[0,jd,D,cd];else{if(ca<=Z[1]){var
...
Q=function(a){return L(d$.random()*1e9|0)},aG=Q(0),R=h(i1,h(Q(0),aG)),al=[0,jg,[0,h(jf,R)],[0,164354597,R]];else
var
al=jh;var
am=al;break}}else
var
...
c=d_(a),b=aq(F(O(c,1),aB).toLowerCase());if(Y(b,ic))if(Y(b,id)){if(Y(b,ie))if(Y(b,ig)){if(Y(b,ih))if(Y(b,ii))var
d=1,f=0;else
var
f=1;else
var
...
e=0,g=1}if(g){var
h=ac(F(O(c,5),aB)),k=function(a){return E(it)},l=ac(F(O(c,9),k)),m=function(a){return E(iu)},n=cH(F(O(c,7),m)),o=a_(h),p=function(a){return E(iv)},i=aq(F(O(c,4),p)),q=Y(i,is)?eY(i):e?e9:80,j=[0,ac(F(O(c,2),aB)),q,o,h,n,l],r=e?[1,j]:[0,j];return[0,r]}}throw[0,ib]},aA=function(a){function
b(a){var
b=d_(a),c=ac(F(O(b,2),aB));function
d(a){return E(iw)}var
e=aq(F(O(b,6),d));function
f(a){return E(ix)}var
g=cH(F(O(b,4),f));return[0,[2,[0,a_(c),c,g,e]]]}function
c(a){return 0}return bG(ir.exec(K),c,b)},J=bG(ip.exec(K),aA,az);if(J){var
x=J[1];switch(x[0]){case
0:var
S=x[1],T=S.slice(),aI=S[5];T[5]=0;var
j=[0,eu([0,T]),aI],n=1;break;case
1:var
U=x[1],W=U.slice(),aJ=U[5];W[5]=0;var
j=[0,eu([1,W]),aJ],n=1;break;default:var
n=0}}else
var
n=0;if(!n)var
j=[0,a,0];var
ab=j[1],ad=dv(j[2],aM),ae=ad?h(ab,h(je,bO(ad))):ab,af=bF(0),ag=af[2],ah=af[1];try{var
...
aC=new(l.activeXObject)("Microsoft.XMLHTTP")}catch(f){throw[0,C,i0]}var
...
c=ai[1]?0:z(aO,b.status,y)?0:(d2(ag,[1,[0,jc,[0,b.status,y]]]),b.abort(),1);ai[1]=1;return 0};b.onreadystatechange=bf(function(a){switch(b.readyState){case
2:if(!ec)return A(0);break;case
3:if(ec)return A(0);break;case
4:A(0);var
c=function(a){var
c=d9(b.responseXML);if(c){var
d=c[1];return V(d.documentElement)===N?0:[0,d]}return 0};return a5(ag,[0,ae,b.status,y,new
...
aj=B[2];if(typeof
$===u){var
aT=aj[1];b.send(V(a0(ja,aL(function(a){var
...
c=V(a.join(d));return aN(b.sendAsBinary)?b.sendAsBinary(c):b.send(c)},aV=aj[1],e=new
bI(),aH=function(a){e.push(h(i3,h(ak,i2)).toString());return e};d6(d6(d8(function(a){e.push(h(i5,h(ak,i4)).toString());var
g=a[2],n=a[1];if(b4<=g[1]){var
b=g[2],s=function(a){var
c=bH(b.name),g="Content-Type: application/octet-stream\r\n",i='"\r\n';if(c)var
f=c[1];else
var
d=bH(b.fileName),f=d?d[1]:aX(h0);e.push(h(i7,h(n,i6)).toString(),f,i,g);e.push(b1,a,b1);return I(0)},k=bH(bJ(h1)),d=-1041425454;if(k){var
c=new(k[1])(),i=bF(0),j=i[1],p=i[2];c.onloadend=m(function(a){if(2===c.readyState){var
b=c.result,e=kn(typeof
b,bm)?V(b):N,d=d9(e);if(!d)throw[0,C,h2];a5(p,d[1])}return q});cG(j,function(a){return c.abort()});if(typeof
d===u)if(e5===d)c.readAsDataURL(b);else
if(fx<=d)c.readAsText(b);else
c.readAsBinaryString(b);else
c.readAsText(b,d[2]);var
o=j}else{var
f=function(a){return aX(h3)};if(typeof
d===u)var
l=e5===d?aN(b.getAsDataURL)?b.getAsDataURL():f(0):fx<=d?aN(b.getAsText)?b.getAsText("utf8"):f(0):aN(b.getAsBinary)?b.getAsBinary():f(0);else
var
r=d[2],l=aN(b.getAsText)?b.getAsText(r):f(0);var
o=I(l)}return d5(o,s)}var
t=g[2];e.push(h(i9,h(n,i8)).toString(),t,b1);return I(0)},aV),aH),aU)}}else
b.send(B[2])}else
...
bP(a,b){var
c=en(l.document);c.width=a;c.height=b;return c}var
...
jm(a){var
b=a.getItem(fk);return b==N?eB(0):b}var
ad=[0,a6(l.localStorage,eB,jm)];ab.log(ad[1]);function
eC(a){return ew(a[ad[1]])}function
eD(a){var
e=A(Q.padding,0),b=A(Q.border,fR)+e,c=a.width,d=a.height,f=ak(5,c/2-b);return[0,f,ak(5,d/2-b),c/2,d/2]}function
bS(a,b,c){var
d=eD(a),e=[n,(b-d[3])/d[1],(c-d[4])/d[2]],f=cL(e);return f<=e2?e:cK(e,f/e2)}var
...
eG(a){var
b=a[2],c=1;return bz(function(a,b){return a+eG(b)|0},c,b)}function
eH(a){var
b=a[2],c=0;return bz(function(a,b){return(a+1|0)+eH(b)|0},c,b)}function
eI(a){var
b=a[2],d=b.length-1-1|0;if(!(d<0)){var
c=d;for(;;){var
f=i(b,c),e=d$.random()*(c+1|0)|0;k(b,c,i(b,e));k(b,e,f);var
g=c-1|0;if(0!==c){var
c=g;continue}break}}return bx(eI,b)}var
bd=[0,0],eJ=[0,function(a){return 0}];function
eK(a){bd[1]=0;return j(eJ[1],0)}function
X(a){return bd[1]?0:(bd[1]=1,j(hZ,bf(function(a){return bd[1]?eK(0):0})))}a9(jt);a9(ju);a9(jv);function
eL(a,b){try{var
O=bA(ad[1],a)[1],m=O}catch(f){f=s(f);if(f[1]!==t)throw f;try{var
N=bA(aH,a)[1],v=N}catch(f){f=s(f);if(f[1]!==t)throw f;var
v=dY(0,11)}var
m=v}try{var
M=dZ(m,jx),w=M}catch(f){f=s(f);if(f[1]!==t)throw f;var
w=jw}e.title=w.toString();var
...
D=dZ(m,B),q=A(Q.nodeFont,"20px sans-serif"),o=ap(bR),j=Z===o?bR[1]:ai===o?a2(bR):bR;j.style.font=q;var
p=e.createTextNode(D.toString());g(j,p);var
F=j.clientHeight,G=j.clientWidth;aO(j,p);var
f=G+8|0,h=F+8|0,r=bP(f,h),c=r.getContext(bK);c.fillStyle=A(Q.nodeBackgroundColor,cJ);var
d=ck(4,ck(f,h)/2);c.beginPath();c.moveTo(0+d,0);c.arcTo(0+f,0,0+f,0+d,d);c.arcTo(0+f,0+h,0+f-d,0+h,d);c.arcTo(0,0+h,0,0+h-d,d);c.arcTo(0,0,0+d,0,d);c.fill();c.font=q;c.fillStyle=A(Q.nodeColor,"black");c.textAlign=fa;c.textBaseline=cX;c.fillText(D.toString(),f/2,h/2);var
...
c=by(eN,b);return[0,0.6*eM(c),c]}function
eQ(a){var
h=A(Q.buttonColor,"#888888"),d=bP(32,32),b=d.getContext(bK);b.save();b[c(c$)]=2;b.strokeStyle=h;if(a){b[c("shadowBlur")]=4;b.shadowColor=h}b.beginPath();var
e=4+4/fI,g=28-4/fI;b.moveTo(e,e);b.lineTo(g,g);b.moveTo(e,g);b.lineTo(g,e);b.stroke();b.restore();var
i=a?jF:jG;d.className=i.toString();d.style.position=y;d.style.top=f;d.style.right=f;return d}function
be(a,b,c){function
j(a){var
i=bN(e);i.src=cI(c);var
d=p(e);d.style.position=y;d.style.width=dd;var
j=d.style;j.height=h(L(ak(38,b)),jH).toString();d.style.margin=bn;d.style.borderRadius=bn;var
f=ak(6,44-b|0),k=d.style,l=h(jJ,h(L(f-(f/2|0)|0),jI));k.padding=h(L(f/2|0),l).toString();var
m=a?jK:jM;d.className=h(jL,m).toString();g(d,i);return d}var
d=p(e);d.className=cb;d.style.width=b$;var
k=d.style;k.height=h(L(8+ak(38,b)|0),jN).toString();if(a){var
...
d=[0,N];d[1]=V(aa(e,hE,m(function(a){function
e(a){ay(d[1],W);b.className=de;c[1]=0;return I(0)}M(eo(0),e);return o}),o));b.className=b2}aP(a);return q})}function
eS(V,b,c,d){return M(b,function(a){var
z=eC(V),B=[0,-1],G=a.length-1-1|0,W=c.toString(),X=0;if(!(G<0)){var
...
c=b.style;c.maxHeight=h(L(k[5]),jO).toString();g(b,a);return b},b=bN(e),J=ap(d),Y=Z===J?d[1]:ai===J?a2(d):d,M=d7(Y);if(M){var
_=M[1],s=bP(k[4],k[5]),$=s.getContext(bK);$.drawImage(_,0,0,k[4],k[5]);s.style.display=fQ;s.style.height=K;s.style.width=K;s.style.maxWidth=P;s.style.maxHeight=P;s.style.marginLeft=K;s.style.marginRight=K;var
N=H(s);g(l,N);b.onload=m(function(a){aO(l,N);return q})}var
O=k[7],aa=O?O[1]:h(jX,h(c,jW)).toString();b.src=aa;b.width=k[4];b.height=k[5];b.style.display=fQ;b.style.height=K;b.style.width=K;b.style.maxWidth=P;b.style.maxHeight=P;b.style.marginLeft=K;b.style.marginRight=K;var
...
j=p(e);g(j,r);j.className=fo;j.style.width=P;j.style.height=P;j.style.position=y;j.style.top=f;j.style.left=f;j.style.zIndex=fL;var
t=p(e);t.className=cb;t.style.position=y;t.style.top=f;t.style.right=f;t.style.cursor=bl;g(t,eQ(1));g(t,eQ(0));var
...
ac=ad[1]===aH?jP:h(jV,new
v(ad[1])),S=be([0,h(jQ,h(new
v(k[2]),ac)).toString()],52,jR),D=bT(A(z.wikimediaCommons,"See image description on Wikimedia Commons"));D.style.left=b$;D.style.top="12px";g(S,D);g(w,S);var
E=be(0,34,jS),n=p(e),T=[0,0],F=ei(e),U=function(a,b){var
d=eh(e),f=[0,1],j=k[6];bx(function(a){var
i=a[1],l=a[3];if(a[2]===b){f[1]=0;var
c=bM(e);g(c,e.createTextNode(i));c.target=dl;var
j=new
v(l),m=0===j.getLen()?new
v(i):j,n=h(jT,m);c.href=h(jU,h(new
v(b),n)).toString();var
k=ej(e);g(k,c);return g(d,k)}return 0},j);if(f[1])return 0;T[1]++;var
c=ek(e);g(c,e.createTextNode(a));g(F,c);var
i=el(e);g(i,d);return g(F,i)},ae=ad[1];U(A(z.language,ff),ae);if(ad[1]!==aH)U(ff,aH);if(0<T[1])g(n,F);else
g(n,e.createTextNode(A(z.noRef,"No reference found.")));n.className=de;n.style.position=y;n.style.left=b$;n.style.top="62px";n.style.whiteSpace=dj;g(E,n);g(w,E);n.onclick=m(function(a){aP(a);return o});eR(E,n);w.onclick=m(function(a){aP(a);return o});g(j,w);g(e.body,j);j.onclick=m(function(a){aO(e.body,j);return o})}return I(0)})}var
jZ=jY.toString();av(function(a){eA(cI(a));return 0},jk);function
jn(a){return I(cP.parse(a.toString()))}var
jp=M(cQ(jo),jn);function
jB(a){var
u=cP.parse(a.toString()),B=u[1],J=u[2];eI(B);function
K(a){var
...
E=eF(eF(J,function(a){return by(K,a)}),ge);function
o(a,b){var
c=new
...
b(a){function
b(a){X(0);return I(a)}return M(eA(h(js,h(e,jr)).toString()),b)}return M(eo(0),b)}],e]];else
var
d=[0,b7,[0,a,0,c]];return[0,d,by(function(a){return o(0,a)},f)]}var
d=o(1,B),c=eG(d),w=r(c,ba),x=r(eH(d),jz),g=r(c,[0,[0],c5]),y=[0,0],z=[0,0],H=eN(d);function
A(a,b,c,d,e,f){var
o=a[2],l=b[2],p=y[1],H=a[1];y[1]++;k(w,p,d[1]);if(0===o.length-1)var
v=[0];else{var
q=eM(l),I=[0,0],J=c?(q-i(l,0)[1])/2:0,s=[0,J],B=function(a,b){var
h=b[1],c=Math.acos(f[1])*h/q,i=Math.acos(f[1])*((s[1]+h/2)/q*2-1);I[1]++;s[1]=s[1]+h;var
g=bc/3,l=[n,(Math.cos(c)-Math.cos(g))/(1-Math.cos(g+c)),0],r=[n,Math.cos(g),Math.sin(g)],m=fw<l[1]?[0,l,r]:[0,eO,j(aD(aC(eO)),[n,Math.cos(c),Math.sin(c)])],t=m[2],o=A(a,b,0,ez(ez([0,m[1],D],[0,ba,[n,Math.cos(i),Math.sin(i)]]),d),e*0.94,t),u=o[1],v=z[1];z[1]++;k(x,v,[0,p,u,e]);return o},m=o.length-1;if(l.length-1!==m)throw[0,C,jy];if(0===m)var
E=[0];else{var
...
t=A(d,H,1,[0,ba,D],6,jA),f=r(g.length-1,[0,[0],[0]]);function
...
q(a,b,c,d){var
g=a[2],j=a[1];k(p,j,kf([0,b,[0,c,[0,d,[0,by(function(a){return m(l(a))},g),0]]]]));var
...
G=b+1|0;if(s!==b){var
b=G;continue}break}}eL(E,g);return I([0,[0,w,x,g,[0,r(c,0),r(c,0),r(c,0),r(c,0)]],E])}var
jC=M(cQ(jq),jB);function
jD(a){return I(cP.parse(a.toString()))}var
eP=M(cQ(jE),jD);l.onload=m(function(a){try{en(l.document);var
v=am(M(jC,function(a){var
E=a[2],b=a[1],v=b[4],C=b[3],aL=b[2],L=b[1];return M(jp,function(F){var
x=e.documentElement;x.style.overflow=da;x.style.height=P;e.body.style.overflow=da;e.body.style.margin=e4;e.body.style.height=P;var
h=bP(x.clientWidth,x.clientHeight);g(e.body,h);var
b=[0,[0,ba,D]],r=[0,b[1]],H=L.length-1,w=0===H?[0]:ki(L,0,H);eJ[1]=function(a){bd[1]=0;ab.time(dc);var
...
y=aT;for(;;){k(w,y,ey(aa,ac,aS,D,i(L,y)));var
aU=y+1|0;if(ad!==y){var
y=aU;continue}break}}ab.timeEnd(dc);ab.time(fh);var
b=h.getContext(bK),d=eD(h),E=d[4],F=d[3],aV=d[2],aW=d[1];b.clearRect(0,0,h.width,h.height);var
as=A(Q.padding,0);b.beginPath();eE(b,F,E,aW+as,aV+as,0,7,q);function
aX(a){b.fillStyle=a;return b.fill()}an(Q.backgroundColor,aX);function
aY(a){b[c(c$)]=1;b.strokeStyle=a;return b.stroke()}an(Q.boundaryColor,aY);b[c(c$)]=2;b.lineCap="round";b.strokeStyle=A(Q.treeColor,cJ);var
...
aq=aQ(e)+1,ar=aQ(g)+1,j=[n,(g[2]*aq-e[2]*ar)/R,(e[1]*ar-g[1]*aq)/R],ae=d[4],af=d[3],M=d[2],s=d[1],N=cL(cN(e,j)),O=Math.atan2(e[2]-j[2],e[1]-j[1]),P=Math.atan2(g[2]-j[2],g[1]-j[1]);b.beginPath();var
ag=(P-O+2*bc)%(2*bc);if(s==M)b.arc(j[1]*s+af,j[2]*s+ae,N*s,O,P,!!(bc<ag?1:0));else
eE(b,j[1]*s+af,j[2]*M+ae,N*s,N*M,O,P,!!(bc<ag?1:0));b.stroke()}}var
...
f=a1;continue}break}}ab.timeEnd(fh);return ab.log(au[1],av[1])};eK(0);l.onresize=m(function(a){var
...
f=a.clientX,g=a.clientY,c=[0,0],k=[0,N],l=aa(e,hI,m(function(a){var
...
d=1;else
var
k=0,d=0;if(d){c[1]=1;h.style.cursor=fm;var
k=1}}if(c[1]){var
l=bS(h,f,g),m=bS(h,e,i);r[1]=[0,aR(j(aD(aC(b[1][1])),l),m),D];X(1)}aP(a);return o}),o);k[1]=V(aa(e,hG,m(function(a){W(l);ay(k[1],W);if(c[1]){h.style.cursor=d;var
...
j=0;else
if(dk===e[1]){var
g=e[2];eS(F,eP,g[2],g[1]);var
j=1}else
var
j=0}}return o}),o));return o});aa(h,hL,m(function(a){function
c(a){var
f=a.identifier,l=a.clientX,n=a.clientY,c=[0,0],p=aa(e,hN,m(function(a){var
...
d=1;else
var
i=0,d=0;if(d){c[1]=1;h.style.cursor=fm;var
...
k=d+1|0;if(e!==d){var
d=k;continue}break}}aP(a);return q}),o),g=[0,N],k=[0,N];g[1]=V(aa(e,ee,m(function(a){var
...
e=i(C,j)[2];if(typeof
e!==u)if(dk===e[1]){var
l=e[2];eS(F,eP,l[2],l[1]);return 0}return 0}return 0}return 0};an(a.changedTouches.item(e),m);var
n=e+1|0;if(j!==e){var
e=n;continue}break}}return o}),o));k[1]=V(aa(e,ee,m(function(a){var
...
m=e+1|0;if(i!==e){var
e=m;continue}break}}return q}),o));return 0}an(a.changedTouches.item(0),c);return q}),o);aa(e,ed,m(function(a){var
c=a.keyCode-37|0;if(3<c>>>0)return o;switch(c){case
1:r[1]=[0,aR(j(aD(aC(b[1][1])),j2),j3),D];b[1]=r[1];X(1);return q;case
2:r[1]=[0,aR(j(aD(aC(b[1][1])),j4),j5),D];b[1]=r[1];X(1);return q;case
3:r[1]=[0,aR(j(aD(aC(b[1][1])),j6),j7),D];b[1]=r[1];X(1);return q;default:r[1]=[0,aR(j(aD(aC(b[1][1])),j0),j1),D];b[1]=r[1];X(1);return q}}),o);var
M=[0,0];function
O(a){var
x=M[1];if(x)aO(e.body,x[1]);var
c=p(e);c.style.position=y;c.style.right=f;c.style.bottom=f;var
n=eC(F),i=be(0,38,j8);i.style.position=y;i.style.bottom=bn;i.style.right=f;i.style.cursor=bl;i.onclick=m(function(a){try{var
J=bA(ad[1],E)[2],C=J}catch(f){f=s(f);if(f[1]!==t)throw f;try{var
I=bA(aH,E)[2],B=I}catch(f){f=s(f);if(f[1]!==t)throw f;var
B=jZ}var
C=B}var
b=p(e);b.className=b2;b.style.width=fe;b.style.margin=K;b.innerHTML=C;var
i=p(e);i.style.display=fO;i.style.verticalAlign=cX;g(i,b);var
f=p(e);f.style.width=P;f.style.height=P;f.style.display=fM;g(f,i);var
j=p(e);j.className="overlay translucent";g(j,f);var
D=[0,N];function
F(a){aO(e.body,j);return ay(D[1],W)}D[1]=V(aa(e,ed,m(function(a){var
...
var
v=0;if(!v){var
w=ef[1];if(fH===w){try{var
y=e.createElement('<input name="x">'),z=y.tagName.toLowerCase()==="input"?1:0,H=z?y.name===df?1:0:z,x=H}catch(f){var
x=0}var
G=x?fz:-1003883683;ef[1]=G;continue}if(fz<=w){var
c=new
bI();c.push("<",cb);bL(u,function(a){c.push(' type="',e1(a),at);return 0});bL(r,function(a){c.push(' name="',e1(a),at);return 0});c.push(">");var
h=e.createElement(c.join(d))}else{var
l=a8(e,eg);bL(u,function(a){return l.type=a});bL(r,function(a){return l.name=a});var
h=l}}g(h,e.createTextNode(A(n.ok,"OK")));h.onclick=m(function(a){F(0);return q});var
k=p(e);k.style.textAlign=fa;k.style.margin="2em auto";g(k,h);g(b,k);g(e.body,j);return q}});var
u=bT(A(n.info,"Information"));u.style.right=cc;u.style.bottom=cc;g(i,u);g(c,i);var
j=be(0,38,j9);j.style.position=y;j.style.bottom=bn;j.style.right=b$;j.style.cursor=bl;var
h=p(e),v=ei(e),z=eh(e);av(function(a){var
d=a[2],f=a[1],b=bM(e);g(b,e.createTextNode(f.toString()));b.href=bh;b.onclick=m(function(a){var
b=d.toString();function
c(a){return a.setItem(fk,b)}an(l.localStorage,c);ad[1]=b;O(0);eL(E,C);X(1);return q});var
c=ej(e);g(c,b);return g(z,c)},j_);var
B=ek(e);g(B,e.createTextNode(A(n.languages,"Languages")));g(v,B);var
G=el(e);g(G,z);g(v,G);g(h,v);h.className=de;h.style.position=y;h.style.right=e4;h.style.bottom="46px";h.style.whiteSpace=dj;g(j,h);eR(j,h);g(c,j);var
k=be(0,38,j$);k.style.position=y;k.style.bottom=bn;k.style.right="96px";k.style.cursor=bl;k.onclick=m(function(a){r[1]=[0,ba,D];b[1]=r[1];X(1);return q});var
w=bT(A(n.recenter,"Recenter"));w.style.right=cc;w.style.bottom=cc;g(k,w);g(c,k);g(e.body,c);M[1]=[0,c];return 0}O(0);var
R=bN(e);R.src=cI(ka);var
B=bM(e);B.target=dl;B.href="http://ocsigen.org/";g(B,R);var
...
0:return 0;case
1:return j(cB[1],a[1]);default:throw[0,C,hv]}});break;case
3:throw[0,C,hw]}}catch(f){f=s(f);if(f[1]===em){var
b=p(e);b.className=b2;b.style.width=fe;b.style.margin=K;b.innerHTML='Unfortunately, this browser is not supported. Please try again with another browser, such as <a href="http://www.mozilla.org/firefox/">Firefox</a>, <a href="http://www.google.com/chrome/">Chrome</a> or <a href="http://www.opera.com/">Opera</a>.';var
r=p(e);r.style.display=fO;r.style.verticalAlign=cX;g(r,b);var
h=p(e);h.style.width=P;h.style.height=P;h.style.display=fM;g(h,r);var
w=p(e);w.className=fo;g(w,h);g(e.body,w);return q}throw f}return q});cl(0);return}(function(){return this}()));
