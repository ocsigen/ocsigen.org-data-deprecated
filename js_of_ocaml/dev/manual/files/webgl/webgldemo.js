   ...
   {"use strict";
    ...
    var
     ...
     _cg_=
      caml_new_string
       ("^([Ff][Ii][Ll][Ee])://([^\\?#]*)(\\?([^#]*))?(#(.*))?$"),
     _ck_=[0,caml_new_string("xmlHttpRequest.ml"),87,2],
     _cl_=caml_new_string("XmlHttpRequest.Wrong_headers"),
     _cJ_=
      [0,
    ...
    function unsafeCoerce(tag,e)
     {var _eH_=tag.toString();
      return e.tagName.toLowerCase() === _eH_?e:no_handler}
    ...
    if(!caml_string_equal(git_version,_b__))_a_(s,_a_(_cK_,git_version));
    function regexp(s)
     {return new regExp_withFlags(caml_bytes_of_string(s),"g")}
    function string_match(r,s,i)
     {r.lastIndex = i;
      var x=r.exec(caml_bytes_of_string(s)),_eG_=x == no_handler?no_handler:x;
      return to_option(_eG_)}
    function matched_group(r,i)
     {var x=r[i],_eF_=x === t37?t37:caml_js_to_byte_string(x);
      function _eE_(x){return [0,x]}
      return case$1(_eF_,function(param){return 0},_eE_)}
    ...
    new regExp_withFlags(caml_bytes_of_string(_cg_));
    var x=window.location;
    if(x !== t37)
     var _ch_=window.location;
    else
     var
      t29="",
    ...
    urldecode_js_string_string(_ch_.hostname);
    urldecode_js_string_string(_ch_.protocol);
    var _ci_=0;
    (function(param)
       {try
         {var _eA_=[0,caml_int_of_string(caml_js_to_byte_string(_ch_.port))];
          return _eA_}
        catch(_eB_)
      ...
      (_ci_));
    var
     s$1=urldecode_js_string_string(_ch_.pathname),
    ...
    var
     ...
     arr=_cj_.split(make$0(1,38).toString()),
     len=arr.length;
     ...
     {var idx$0=idx;
      for(;;)
       {if(0 <= idx$0)
        ...
        return acc}}
    aux$0(0,len - 1 | 0);
    urldecode_js_string_string(_ch_.href);
       ...
       {try
         ...
         {try
           ...
           {try
            ...
            catch(_ep_){throw [0,Assert_failure,_ck_]}}}}}
            ...
            for(;;)
             {if(0 <= idx)
               {var idx$0=idx - 1 | 0,x=a[idx];
                if(x === t37)throw [0,Assert_failure,_b$_];
                var
