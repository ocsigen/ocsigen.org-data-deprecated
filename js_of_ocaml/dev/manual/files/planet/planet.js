...
(function(joo_global_object)
   {"use strict";
        ...
        for(;;)
         {if(param$0)
           {var l=param$0[2],a=param$0[1];
            try {caml_ml_flush(a)}catch(_g8_){}
            var param$0=l;
            continue}
          return 0}}
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i)
       if(!(l < i))
        try
         {index_rec(s,l,i,c);var _g6_=1;return _g6_}
        catch(_g7_)
         {_g7_ = caml_wrap_exception(_g7_);
          if(_g7_ === Not_found)return 0;
          throw _g7_}
    ...
    function map(f,a)
     {var l=a.length - 1;
      if(0 === l)return [0];
      var r=caml_make_vect(l,caml_call1(f,a[1])),_g4_=l - 1 | 0,_g3_=1;
      if(!(_g4_ < 1))
       {var i=_g3_;
        for(;;)
    ...
    function _y_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_g2_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_g2_]}
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_gX_=height(lr);
            if(_gX_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _gY_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_gY_)}
            return invalid_arg(_q_)}
          return invalid_arg(_r_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_gZ_=height(rl);
            if(_gZ_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _g0_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_g0_)}
            return invalid_arg(_s_)}
          return invalid_arg(_t_)}
        var _g1_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_g1_]}
      var empty=0;
      ...
      function max_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _gS_=param$0[4],_gT_=param$0[3],_gU_=param$0[2];
         ...
         {var _gR_=param[1];
          if(_gR_)
           {var r=param[4],d=param[3],x=param[2];
            return bal(remove_min_binding(_gR_),x,d,r)}
          var r$0=param[4];
          return r$0}
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _gL_=caml_call2(p,v,d);
            if(_gL_)
             var _gM_=_gL_;
            else
             {var _gN_=exists(p,l);
              if(!_gN_){var param$0=r;continue}
              var _gM_=_gN_}
            return _gM_}
          return 0}}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _gH_=merge(f,r1,r2),
             _gI_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_gI_,_gH_)}}
        else
         if(!s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _gJ_=merge(f,r1$0,r2$0),
           _gK_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_gK_,_gJ_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _gF_=concat(lf,rf);return [0,join(lt,v,d,rt),_gF_]}
          var _gG_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_gG_]}
        return _x_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _gC_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_gC_)
               {var _gD_=caml_call2(cmp,d1,d2);
                if(_gD_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_gB_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _gB_ | 0}
        return 0}
       ...
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _ge_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_ge_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _gf_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _gg_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _gh_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _gi_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _gj_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _gk_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _gl_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _gm_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _gn_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _go_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _gp_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _gq_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _gr_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _gs_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _gt_=function(param){caml_call1(de$12,0);return 0},
           _gu_=function(param){caml_call1(ed$12,0);return 0},
           _gv_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _gw_=function(param){caml_call1(de$13,0);return 0},
           _gx_=function(param){caml_call1(ed$13,0);return 0},
           _gy_=function(param){caml_call1(af$13,0);return 0};
          return [0,
        ...
        {case 0:
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_f0_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_f1_,rest2$6)];
          ...
          break;
         case 8:
          var _f2_=ty1[2],_f3_=ty1[1];
          if(typeof match === "number")
           var switch$9=1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_f4_=trans(_f2_,rest2$7);
              return [8,trans(_f3_,ty2),_f4_];
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_f8_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_f9_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_f__,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_f$_,rest2$12)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$14=0;break;
             ...
             case 14:var rest2$13=match[1];return [14,trans(_ga_,rest2$13)];
        ...
        {case 0:
         ...
         case 2:
          ...
          if(typeof _fs_ !== "number" && 1 === _fs_[0])
           {var
             ...
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_ft_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _fu_=type_padding(pad$0,fmtty),
           _fv_=_fu_[2],
           _fw_=_fu_[1];
          if(typeof _fv_ !== "number" && 1 === _fv_[0])
           {var
             fmtty_rest$2=_fv_[1],
             match$2=type_format_gen(fmt_rest$2,fmtty_rest$2),
             fmtty$3=match$2[2],
             fmt$3=match$2[1];
            return [0,[3,_fw_,fmt$3],fmtty$3]}
          throw Type_mismatch;
         case 4:
          var
           fmt_rest$3=fmt[4],
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _fx_=type_padprec(pad$1,prec,fmtty),
           _fy_=_fx_[3],
           _fz_=_fx_[2],
           _fA_=_fx_[1];
          if(typeof _fy_ !== "number" && 2 === _fy_[0])
           {var
             fmtty_rest$3=_fy_[1],
             match$3=type_format_gen(fmt_rest$3,fmtty_rest$3),
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_fA_,_fz_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _fB_=type_padprec(pad$2,prec$0,fmtty),
           _fC_=_fB_[3],
           _fD_=_fB_[2],
           _fE_=_fB_[1];
         ...
         case 6:
          var
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _fF_=type_padprec(pad$3,prec$1,fmtty),
           _fG_=_fF_[3],
           _fH_=_fF_[2],
           _fI_=_fF_[1];
         ...
         case 7:
          var
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _fJ_=type_padprec(pad$4,prec$2,fmtty),
           _fK_=_fJ_[3],
           _fL_=_fJ_[2],
           _fM_=_fJ_[1];
         ...
         case 8:
          var
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _fN_=type_padprec(pad$5,prec$3,fmtty),
           _fO_=_fN_[3],
           _fP_=_fN_[2],
           _fQ_=_fN_[1];
      ...
      for(;;)
       {if(caml_ml_string_length(str) <= i$1)
         ...
         {var match$0=caml_string_unsafe_get(str,i$1);
          if(32 <= match$0)
           {var _fm_=match$0 - 34 | 0;
            if(58 < _fm_ >>> 0)
             if(93 <= _fm_)var switch$0=0,switch$1=0;else var switch$1=1;
            else
             if(56 < (_fm_ - 1 | 0) >>> 0)
              var switch$0=1,switch$1=0;
             else
          ...
          var _fn_=switch$0?1:1}
        if(_fn_)
         {var n=[0,0],_ff_=caml_ml_string_length(str) - 1 | 0,_fe_=0;
          if(!(_ff_ < 0))
           {var i$0=_fe_;
            for(;;)
             {var match=caml_string_unsafe_get(str,i$0);
              if(32 <= match)
               {var _fj_=match - 34 | 0;
                if(58 < _fj_ >>> 0)
                 if(93 <= _fj_)var switch$2=0,switch$3=0;else var switch$3=1;
                else
                 if(56 < (_fj_ - 1 | 0) >>> 0)
                  var switch$2=1,switch$3=0;
                 else
                  var switch$3=1;
                if(switch$3)var _fk_=1,switch$2=2}
              else
          ...
          if(n[1] === caml_ml_string_length(str))
           ...
           {var s=caml_create_string(n[1]);
            n[1] = 0;
            var _fh_=caml_ml_string_length(str) - 1 | 0,_fg_=0;
            if(!(_fh_ < 0))
             {var i=_fg_;
              for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 0:var _fd_=_ap_;break;
        case 1:var _fd_=_aq_;break;
        case 2:var _fd_=_ar_;break;
        case 3:var _fd_=_as_;break;
        case 4:var _fd_=_at_;break;
        case 5:var _fd_=_au_;break;
        case 6:var _fd_=_av_;break;
        case 7:var _fd_=_aw_;break;
        case 8:var _fd_=_ax_;break;
        case 9:var _fd_=_ay_;break;
        case 10:var _fd_=_az_;break;
        case 11:var _fd_=_aA_;break;
        default:var _fd_=_aB_}
      return caml_format_int(_fd_,n)}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 0:var _fc_=_aP_;break;
        case 1:var _fc_=_aQ_;break;
        case 2:var _fc_=_aR_;break;
        case 3:var _fc_=_aS_;break;
        case 4:var _fc_=_aT_;break;
        case 5:var _fc_=_aU_;break;
        case 6:var _fc_=_aV_;break;
        case 7:var _fc_=_aW_;break;
        case 8:var _fc_=_aX_;break;
        case 9:var _fc_=_aY_;break;
        case 10:var _fc_=_aZ_;break;
        case 11:var _fc_=_a0_;break;
        default:var _fc_=_a1_}
      return caml_format_int(_fc_,n)}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 0:var _fb_=_a2_;break;
        case 1:var _fb_=_a3_;break;
        case 2:var _fb_=_a4_;break;
        case 3:var _fb_=_a5_;break;
        case 4:var _fb_=_a6_;break;
        case 5:var _fb_=_a7_;break;
        case 6:var _fb_=_a8_;break;
        case 7:var _fb_=_a9_;break;
        case 8:var _fb_=_a__;break;
        case 9:var _fb_=_a$_;break;
        case 10:var _fb_=_ba_;break;
        case 11:var _fb_=_bb_;break;
        default:var _fb_=_bc_}
      return caml_format_int(_fb_,n)}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 0:var _fa_=_aC_;break;
        case 1:var _fa_=_aD_;break;
        case 2:var _fa_=_aE_;break;
        case 3:var _fa_=_aF_;break;
        case 4:var _fa_=_aG_;break;
        case 5:var _fa_=_aH_;break;
        case 6:var _fa_=_aI_;break;
        case 7:var _fa_=_aJ_;break;
        case 8:var _fa_=_aK_;break;
        case 9:var _fa_=_aL_;break;
        case 10:var _fa_=_aM_;break;
        case 11:var _fa_=_aN_;break;
        default:var _fa_=_aO_}
      return caml_int64_format(_fa_,n)}
     ...
     {if(16 <= fconv)
       {if(17 <= fconv)
        ...
        if(19 <= fconv)
         {var l=caml_ml_string_length(s);
          if(0 === l)return s;
          var r=caml_create_string(l),_e6_=l - 1 | 0,_e5_=0;
          if(!(_e6_ < 0))
           {var i=_e5_;
            for(;;)
             {var c=caml_string_unsafe_get(s,i);
              if(97 <= c)
               if(122 < c)var switch$1=0;else var _e7_=c - 32 | 0,switch$1=1;
              else
               var switch$1=0;
              if(!switch$1)var _e7_=c;
              caml_string_unsafe_set(r,i,_e7_);
              var _e8_=i + 1 | 0;
      ...
      if(15 === fconv)
       ...
       {var prec=abs(prec$0);
        ...
        var _e9_=buffer_contents(buf)}
      var str=caml_format_float(_e9_,x);
      if(15 === fconv)
        ...
        for(;;)
         {if(i$0 === len)
           ...
           {var
             ...
             _e__=match - 46 | 0,
             switch$2=
              23 < _e__ >>> 0?55 === _e__?1:0:21 < (_e__ - 1 | 0) >>> 0?1:0;
            if(!switch$2){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
            var _e$_=1}
          return _e$_?str:_a_(str,_bh_)}}
      return str}
    function make_int_padding_precision(k,o,acc,fmt,pad,match,trans,iconv)
     {if(typeof pad === "number")
       ...
       {if(0 === pad[0])
         {var _e2_=pad[2],_e3_=pad[1];
          if(typeof match === "number")
           return 0 === match
                   ?function(x)
                     {var str=fix_padding(_e3_,_e2_,caml_call2(trans,iconv,x));
                      return make_printf(k,o,[4,acc,str],fmt)}
                   :function(p,x)
                     {var
                       str=
                        fix_padding
                         (_e3_,_e2_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,o,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_e3_,_e2_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,o,[4,acc,str],fmt)}}
        var _e4_=pad[1];
        if(typeof match === "number")
         return 0 === match
                 ?function(w,x)
                   {var str=fix_padding(_e4_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,o,[4,acc,str],fmt)}
                 :function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_e4_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,o,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_e4_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,o,[4,acc,str],fmt)}}}
        ...
        switch(fmt$0[0])
         {case 0:
          ...
          case 9:
           ...
           return function(b)
            {var _e1_=b?_b_:_c_;
             return make_printf(k$0,o,[4,acc$0,_e1_],rest$8)};
          case 10:
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bw_;
      ...
      return caml_call2(sprintf(_bx_),_eM_,_eL_)}
    function fields(x)
     {var n=x.length - 1;
      if(2 < n >>> 0)
       {var _eI_=other_fields(x,2),_eJ_=field(x,1);
        return caml_call2(sprintf(_by_),_eJ_,_eI_)}
      switch(n)
       {case 0:return _bz_;
        case 1:return _bA_;
        default:var _eK_=field(x,1);return caml_call1(sprintf(_bB_),_eK_)}}
        ...
        for(;;)
         {if(param$0)
           {var tl=param$0[2],hd=param$0[1];
            try {var _eG_=caml_call1(hd,x),_eF_=_eG_}catch(_eH_){var _eF_=0}
            if(_eF_){var s=_eF_[1];return s}
            var param$0=tl;
            continue}
     ...
     {try
       {var
         _eC_=
          [0,
           map
            (function(_eE_){return caml_convert_raw_backtrace_slot(_eE_)},
             rbckt)];
        return _eC_}
      catch(_eD_)
    ...
    function print_backtrace(outchan)
     {var
      ...
      if(backtrace)
       {var a=backtrace[1],_eA_=a.length - 1 - 1 | 0,_ez_=0;
        if(!(_eA_ < 0))
         {var i=_ez_;
          for(;;)
           {var
            ...
            if(0 === slot[0])
             var
              ...
              match=
               [0,
                caml_call5
                 (sprintf(_bL_),_ex_,filename,lineno,startchar,endchar)];
            else
             if(0 === slot[1])
              var _ey_=info(0),match=[0,caml_call1(sprintf(_bM_),_ey_)];
             else
              var match=0;
    ...
    function add_queue(x,q)
     {var c=[0,[0,x,0]],_eu_=q[1];
      if(_eu_){var cell=_eu_[1];q[1] = c;cell[2] = c;return 0}
      q[1] = c;
      q[2] = c;
      return 0}
    ...
    function take_queue(q)
     {var _et_=q[2];
      if(_et_)
       {var match=_et_[1],x=match[1],tl=match[2];
        q[2] = tl;
        if(0 === tl)q[1] = 0;
        return x}
      throw Empty_queue}
    ...
    function break_new_line(state,offset,width)
     {pp_output_newline(state);
      ...
      var
       ...
       _es_=state[8],
       real_indent=caml_lessequal(_es_,y)?_es_:y;
     ...
     {if(typeof param === "number")
       switch(param)
        {case 0:
         ...
         case 1:
          var _ef_=state[2];
          if(_ef_){var ls=_ef_[2];state[2] = ls;return 0}
          return 0;
         case 2:
          var _eg_=state[3];
          if(_eg_){var ls$0=_eg_[2];state[3] = ls$0;return 0}
          return 0;
         case 3:
          var _eh_=state[2];
          if(_eh_)
           {var match$0=_eh_[1],width=match$0[2];
            return break_line(state,width)}
          return pp_output_newline(state);
         case 4:
          var _ei_=state[10] !== (state[6] - state[9] | 0)?1:0;
          return _ei_?pp_skip_token(state):_ei_;
         default:
          var _ej_=state[5];
          if(_ej_)
           {var
       ...
       switch(param[0])
        {case 0:
          ...
          return 0;
         case 1:
          var off=param[2],n=param[1],_ek_=state[2];
          if(_ek_)
           {var match$1=_ek_[1],width$0=match$1[2],ty=match$1[1];
            switch(ty)
          ...
          if(_el_)
           {var
            ...
            if(_em_)
             {var x=_em_[1];
              try
               {var _en_=find(insertion_point,tabs$0[1]),x$0=_en_}
              catch(_eo_)
       ...
       {var _ea_=state[27][2];
        if(_ea_)
         {var
           ...
           tok=x[2],
           _eb_=size < 0?1:0,
           _ec_=_eb_?(state[13] - state[12] | 0) < state[9]?1:0:_eb_,
           _ed_=1 - _ec_;
          if(_ed_)
           {take_queue(state[27]);
    ...
    function advance_left(state)
     {try
       {var _d__=advance_loop(state);return _d__}
      catch(_d$_)
       {_d$_ = caml_wrap_exception(_d$_);
        if(_d$_ === Empty_queue)return 0;
        throw _d$_}}
         ...
         switch(tok[0])
          {case 3:
            var
             _d8_=1 - ty,
             _d9_=
              _d8_?(queue_elem[1] = state[13] + size | 0,state[1] = t,0):_d8_;
            return _d9_;
           case 1:
           case 2:
            var
    ...
    function default_pp_print_open_tag(_d5_){return 0}
    function default_pp_print_close_tag(_d4_){return 0}
    function make_formatter(output,flush)
     {function i(_d3_){return 0}
      function h(_d2_){return 0}
      ...
      var
       ...
       ppf=
        [0,
         ...
         pp_queue];
      ppf[19] = function(_d1_){return caml_call3(ppf[17],_bT_,0,1)};
      ppf[20]
      =
      function(n$1)
       {var n=n$1;
    ...
    function formatter_of_out_channel(oc)
     {function _dZ_(param){return caml_ml_flush(oc)}
    ...
    function formatter_of_buffer(b)
     {function _dU_(_dY_){return 0}
      return make_formatter
              (function(s,offset,len)
                {var _dV_=offset < 0?1:0;
                 if(_dV_)
                  var _dW_=_dV_;
                 else
                  var
       ...
       {if(1 < state[14])
        ...
        if(state[14] < state[15])
         ...
         if(state[14] === state[15])
          {var
            _dS_=state[16],
            size=caml_ml_string_length(_dS_),
            tok=[0,size,[0,_dS_],size];
    ...
    function repr_rec(t)
     {var _dQ_=t[1];
      if(3 === _dQ_[0])
       {var t$0=_dQ_[1],t$1=repr_rec(t$0);
    ...
    function call_unsafe(f,x)
     {try
       {var _dP_=caml_call1(f,x);return _dP_}
      catch(exn)
    ...
    function wakeup(t$0,v)
     {var t=repr_rec(t$0),_dN_=t[1];
      switch(_dN_[0])
       {case 1:if(_dN_[1] === Canceled)return 0;break;
        case 2:
         var sleeper=_dN_[1],state=[0,v];
         t[1] = state;
         var
          ...
          {if(0 === q[1]){wakening[1] = 0;current_data[1] = snapshot;return 0}
           ...
           if(_dK_)
            {var _dL_=_dK_[1],_dM_=_dK_[2];
             if(_dM_)
              {q[1] = q[1] - 1 | 0;q[2] = _dM_}
             else
              {q[1] = 0;q[2] = 0;q[3] = 0}
             unsafe_run_waiters(_dL_[1],_dL_[2]);
             continue}
           throw Empty}
        }
     ...
     {if(typeof ws !== "number")
       switch(ws[0])
        {case 0:if(!ws[1][1])return 0;break;
         case 2:
          var l2=ws[2],l1=ws[1],_dJ_=cleanup(l2);
          return append(cleanup(l1),_dJ_)
         }
      return ws}
    function connect(t1,t2)
     {var t1$0=repr(t1),t2$0=repr(t2),_dE_=t1$0[1];
      if(2 === _dE_[0])
       {var sleeper1=_dE_[1];
         ...
         {var sleeper2=_dF_[1];
          ...
          var
           ...
           _dI_=
            typeof _dH_ === "number"
             ?_dG_
             :typeof _dG_ === "number"?_dH_:[2,_dH_,_dG_];
          sleeper1[4] = _dI_;
          return 0}
        t1$0[1] = _dF_;
        return unsafe_run_waiters(sleeper1,_dF_)}
      throw [0,Assert_failure,_b3_]}
    function fast_connect(t,state)
     {var t$0=repr(t),_dD_=t$0[1];
      if(2 === _dD_[0])
       {var sleeper=_dD_[1];
        t$0[1] = state;
    ...
    function add_immutable_waiter(sleeper,waiter$0)
     {var
       waiter$1=[1,waiter$0],
       _dC_=sleeper[2],
       waiter=typeof _dC_ === "number"?waiter$1:[2,waiter$1,_dC_];
      sleeper[2] = waiter;
      return 0}
    function bind(t,f)
     {var t$0=repr(t),_dz_=t$0[1];
      switch(_dz_[0])
       {case 0:var v=_dz_[1];return caml_call1(f,v);
        case 1:return [0,_dz_];
        case 2:
         var
          sleeper=_dz_[1],
           ...
           function(state)
            {switch(state[0])
              {case 0:
                ...
                current_data[1] = data;
                try
                 {var _dB_=caml_call1(f,v),_dA_=_dB_}
                catch(exn){exn = caml_wrap_exception(exn);var _dA_=fail(exn)}
                return connect(res,_dA_);
               case 1:return fast_connect(res,state);
               default:throw [0,Assert_failure,_b5_]}});
         return res;
        default:throw [0,Assert_failure,_b6_]}}
    var pause_hook=[0,function(_dy_){return 0}],s1=create$1(0),_b9_=[0,0];
     ...
     {if(e.addEventListener === undefined$0)
       {var
         ...
         callback=
          function(e)
           {var _du_=[0,h,e,[0]];
            return function(_dv_,_dw_){return caml_js_call(_du_,_dv_,_dw_)}};
    ...
    function unsafeCreateElementEx(type,name,doc$0,elt)
     {for(;;)
       {if(0 === type)if(0 === name)return createElement(doc$0,elt);
        var _do_=createElementSyntax[1];
        if(785140586 === _do_)
         {try
           {var
             el=doc.createElement('<input name="x">'),
             _dr_=el.tagName.toLowerCase() === "input"?1:0,
             _ds_=_dr_?el.name === "x"?1:0:_dr_,
             _dp_=_ds_}
          catch(_dt_){var _dp_=0}
          var _dq_=_dp_?982028505:-1003883683;
     ...
     {var match=task(0),w=match[2],t=match[1],d$0=d * 1e3;
      ...
      function loop(step,param)
       {if(2147483e3 < step)
        ...
        var cb=remain == 0?callback:function(_dm_){return loop(remain,_dm_)};
        id[1] = [0,window.setTimeout(caml_js_wrap_callback(cb),step$0)];
        return 0}
      loop(d$0,0);
      function f(param)
       {var _dl_=id[1];
        if(_dl_){var x=_dl_[1];id[1] = 0;return window.clearTimeout(x)}
        return 0}
      var _dj_=repr(t)[1];
      switch(_dj_[0])
       {case 1:var switch$0=_dj_[1] === Canceled?(call_unsafe(f,0),1):0;break;
        case 2:
         var
          sleeper=_dj_[1],
          handler=[0,current_data[1],f],
          _dk_=sleeper[4],
          handler$0=typeof _dk_ === "number"?handler:[2,handler,_dk_];
         sleeper[4] = handler$0;
         var switch$0=1;
         break;
        default:var switch$0=0}
    ...
    function matrix_mul(m$0,m)
     {var
       m$1=matrix_transp(m),
       _dg_=matrix_vect_mul(m$1,m$0[3]),
       _dh_=matrix_vect_mul(m$1,m$0[2]);
      return [0,matrix_vect_mul(m$1,m$0[1]),_dh_,_dg_]}
    ...
    function rotate_object(m,o)
     {var _de_=o[2],_df_=o[1];
      return [0,map(function(v){return matrix_vect_mul(m,v)},_df_),_de_]}
    function tesselate_sphere(p_div,t_div)
     {var
      ...
      var _c2_=p_div - 1 | 0,_c1_=0;
      if(!(_c2_ < 0))
       {var i=_c1_;
        for(;;)
         {var _c4_=t_div - 1 | 0,_c3_=0;
          if(!(_c4_ < 0))
           {var j=_c3_;
            for(;;)
             {var
              ...
              if(0 === j)
               {var
                 _c7_=2 * k | 0,
                 _c6_=[0,north,k,caml_mod(k + t_div | 0,north)];
                caml_check_bound(faces,_c7_)[_c7_ + 1] = _c6_;
                var
                 _c9_=(2 * k | 0) + 1 | 0,
                 _c8_=
                  [0,
                   ...
                   (k + t_div | 0) - 1 | 0];
                caml_check_bound(faces,_c9_)[_c9_ + 1] = _c8_}
              else
               {var
                 _da_=2 * k | 0,
                 _c$_=[0,k,caml_mod(k + t_div | 0,north),k - 1 | 0];
                caml_check_bound(faces,_da_)[_da_ + 1] = _c$_;
                var
                 _db_=caml_mod((k + t_div | 0) - 1 | 0,north),
                 _dd_=(2 * k | 0) + 1 | 0,
                 _dc_=[0,k - 1 | 0,caml_mod(k + t_div | 0,north),_db_];
                caml_check_bound(faces,_dd_)[_dd_ + 1] = _dc_}
              var _c__=j + 1 | 0;
              if(_c4_ !== j){var j=_c__;continue}
              break}}
          var _c5_=i + 1 | 0;
    ...
    function draw(ctx,img,shd,o,uv,normals,face_info,dir)
     {var _c0_=o[2],_cY_=_c0_.length - 1 - 1 | 0,_cX_=0;
      if(!(_cY_ < 0))
       {var i=_cX_;
        for(;;)
         {var
               ...
               {var i=_cT_;
                for(;;)
                 {var
                  ...
                  data[k$0 + 3 | 0] = c$1;
                  var _cW_=i + 1 | 0;
                  if(_cU_ !== i){var i=_cW_;continue}
                  break}}
              var _cV_=j + 1 | 0;
              if(_cS_ !== j){var j=_cV_;continue}
              break}}
                  ...
                  handler
                   (function(ev)
                     {var
                      ...
                      if(0 !== dx)
                       {var _cN_=m[1];
                        m[1] = matrix_mul(xz_rotation(2 * dx / 600),_cN_)}
                      mx[1] = x;
                      my[1] = y;
                      return true$0}),
                  true$0),
               ...
               (doc,
                ...
                handler
                 (function(param)
                   {f(c1);
                    var _cM_=c2[1];
                    if(1 - (_cM_ == no_handler?1:0))f(_cM_);
                    return true$0}),
                true$0);
              return false$0});
          var
             ...
             {var rotation=xz_rotation(phi - phi_rot[1]);
              ...
              function _cI_(param)
               {var
                 ...
                 _cJ_=1 - paused[1],
                 _cK_=_cJ_?follow[1]:_cJ_;
                if(_cK_)phi_rot[1] = phi_rot[1] + angle;
